...
exports.DenomPairTakerFeeProposal = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.DenomPairTakerFeeProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && Array.isArray(o.denomPairTakerFee) && (!o.denomPairTakerFee.length || tx_1.DenomPairTakerFee.is(o.denomPairTakerFee[0])));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.DenomPairTakerFeeProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && Array.isArray(o.denom_pair_taker_fee) && (!o.denom_pair_taker_fee.length || tx_1.DenomPairTakerFee.isSDK(o.denom_pair_taker_fee[0])));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.DenomPairTakerFeeProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && Array.isArray(o.denom_pair_taker_fee) && (!o.denom_pair_taker_fee.length || tx_1.DenomPairTakerFee.isAmino(o.denom_pair_taker_fee[0])));
    },
    ...
    fromAmino(object) {
        ...
        message.denomPairTakerFee = object.denom_pair_taker_fee?.map(e => tx_1.DenomPairTakerFee.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
