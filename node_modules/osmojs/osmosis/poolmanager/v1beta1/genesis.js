...
exports.Params = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.Params.typeUrl || Array.isArray(o.poolCreationFee) && (!o.poolCreationFee.length || coin_1.Coin.is(o.poolCreationFee[0])) && exports.TakerFeeParams.is(o.takerFeeParams) && Array.isArray(o.authorizedQuoteDenoms) && (!o.authorizedQuoteDenoms.length || typeof o.authorizedQuoteDenoms[0] === "string"));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.Params.typeUrl || Array.isArray(o.pool_creation_fee) && (!o.pool_creation_fee.length || coin_1.Coin.isSDK(o.pool_creation_fee[0])) && exports.TakerFeeParams.isSDK(o.taker_fee_params) && Array.isArray(o.authorized_quote_denoms) && (!o.authorized_quote_denoms.length || typeof o.authorized_quote_denoms[0] === "string"));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.Params.typeUrl || Array.isArray(o.pool_creation_fee) && (!o.pool_creation_fee.length || coin_1.Coin.isAmino(o.pool_creation_fee[0])) && exports.TakerFeeParams.isAmino(o.taker_fee_params) && Array.isArray(o.authorized_quote_denoms) && (!o.authorized_quote_denoms.length || typeof o.authorized_quote_denoms[0] === "string"));
    },
    ...
    fromPartial(object) {
        ...
        message.takerFeeParams = object.takerFeeParams !== undefined && object.takerFeeParams !== null ? exports.TakerFeeParams.fromPartial(object.takerFeeParams) : undefined;
    ...
    toAmino(message) {
        ...
        obj.taker_fee_params = message.takerFeeParams ? exports.TakerFeeParams.toAmino(message.takerFeeParams) : undefined;
...
exports.GenesisState = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.GenesisState.typeUrl || typeof o.nextPoolId === "bigint" && exports.Params.is(o.params) && Array.isArray(o.poolRoutes) && (!o.poolRoutes.length || module_route_1.ModuleRoute.is(o.poolRoutes[0])) && Array.isArray(o.poolVolumes) && (!o.poolVolumes.length || exports.PoolVolume.is(o.poolVolumes[0])) && Array.isArray(o.denomPairTakerFeeStore) && (!o.denomPairTakerFeeStore.length || tx_1.DenomPairTakerFee.is(o.denomPairTakerFeeStore[0])));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.GenesisState.typeUrl || typeof o.next_pool_id === "bigint" && exports.Params.isSDK(o.params) && Array.isArray(o.pool_routes) && (!o.pool_routes.length || module_route_1.ModuleRoute.isSDK(o.pool_routes[0])) && Array.isArray(o.pool_volumes) && (!o.pool_volumes.length || exports.PoolVolume.isSDK(o.pool_volumes[0])) && Array.isArray(o.denom_pair_taker_fee_store) && (!o.denom_pair_taker_fee_store.length || tx_1.DenomPairTakerFee.isSDK(o.denom_pair_taker_fee_store[0])));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.GenesisState.typeUrl || typeof o.next_pool_id === "bigint" && exports.Params.isAmino(o.params) && Array.isArray(o.pool_routes) && (!o.pool_routes.length || module_route_1.ModuleRoute.isAmino(o.pool_routes[0])) && Array.isArray(o.pool_volumes) && (!o.pool_volumes.length || exports.PoolVolume.isAmino(o.pool_volumes[0])) && Array.isArray(o.denom_pair_taker_fee_store) && (!o.denom_pair_taker_fee_store.length || tx_1.DenomPairTakerFee.isAmino(o.denom_pair_taker_fee_store[0])));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        ...
        message.takerFeesTracker = object.takerFeesTracker !== undefined && object.takerFeesTracker !== null ? exports.TakerFeesTracker.fromPartial(object.takerFeesTracker) : undefined;
        message.poolVolumes = object.poolVolumes?.map(e => exports.PoolVolume.fromPartial(e)) || [];
        message.denomPairTakerFeeStore = object.denomPairTakerFeeStore?.map(e => tx_1.DenomPairTakerFee.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseGenesisState();
        ...
        message.poolRoutes = object.pool_routes?.map(e => module_route_1.ModuleRoute.fromAmino(e)) || [];
        ...
        message.poolVolumes = object.pool_volumes?.map(e => exports.PoolVolume.fromAmino(e)) || [];
        message.denomPairTakerFeeStore = object.denom_pair_taker_fee_store?.map(e => tx_1.DenomPairTakerFee.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
        ...
        obj.taker_fees_tracker = message.takerFeesTracker ? exports.TakerFeesTracker.toAmino(message.takerFeesTracker) : undefined;
...
exports.TakerFeeParams = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.TakerFeeParams.typeUrl || typeof o.defaultTakerFee === "string" && exports.TakerFeeDistributionPercentage.is(o.osmoTakerFeeDistribution) && exports.TakerFeeDistributionPercentage.is(o.nonOsmoTakerFeeDistribution) && Array.isArray(o.adminAddresses) && (!o.adminAddresses.length || typeof o.adminAddresses[0] === "string") && typeof o.communityPoolDenomToSwapNonWhitelistedAssetsTo === "string" && Array.isArray(o.reducedFeeWhitelist) && (!o.reducedFeeWhitelist.length || typeof o.reducedFeeWhitelist[0] === "string"));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.TakerFeeParams.typeUrl || typeof o.default_taker_fee === "string" && exports.TakerFeeDistributionPercentage.isSDK(o.osmo_taker_fee_distribution) && exports.TakerFeeDistributionPercentage.isSDK(o.non_osmo_taker_fee_distribution) && Array.isArray(o.admin_addresses) && (!o.admin_addresses.length || typeof o.admin_addresses[0] === "string") && typeof o.community_pool_denom_to_swap_non_whitelisted_assets_to === "string" && Array.isArray(o.reduced_fee_whitelist) && (!o.reduced_fee_whitelist.length || typeof o.reduced_fee_whitelist[0] === "string"));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.TakerFeeParams.typeUrl || typeof o.default_taker_fee === "string" && exports.TakerFeeDistributionPercentage.isAmino(o.osmo_taker_fee_distribution) && exports.TakerFeeDistributionPercentage.isAmino(o.non_osmo_taker_fee_distribution) && Array.isArray(o.admin_addresses) && (!o.admin_addresses.length || typeof o.admin_addresses[0] === "string") && typeof o.community_pool_denom_to_swap_non_whitelisted_assets_to === "string" && Array.isArray(o.reduced_fee_whitelist) && (!o.reduced_fee_whitelist.length || typeof o.reduced_fee_whitelist[0] === "string"));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.defaultTakerFee !== "") {
            writer.uint32(10).string(math_1.Decimal.fromUserInput(message.defaultTakerFee, 18).atomics);
        }
    ...
    fromPartial(object) {
        ...
        message.osmoTakerFeeDistribution = object.osmoTakerFeeDistribution !== undefined && object.osmoTakerFeeDistribution !== null ? exports.TakerFeeDistributionPercentage.fromPartial(object.osmoTakerFeeDistribution) : undefined;
        message.nonOsmoTakerFeeDistribution = object.nonOsmoTakerFeeDistribution !== undefined && object.nonOsmoTakerFeeDistribution !== null ? exports.TakerFeeDistributionPercentage.fromPartial(object.nonOsmoTakerFeeDistribution) : undefined;
    ...
    fromAmino(object) {
        ...
        if (object.osmo_taker_fee_distribution !== undefined && object.osmo_taker_fee_distribution !== null) {
            message.osmoTakerFeeDistribution = exports.TakerFeeDistributionPercentage.fromAmino(object.osmo_taker_fee_distribution);
        }
        if (object.non_osmo_taker_fee_distribution !== undefined && object.non_osmo_taker_fee_distribution !== null) {
            message.nonOsmoTakerFeeDistribution = exports.TakerFeeDistributionPercentage.fromAmino(object.non_osmo_taker_fee_distribution);
        }
    ...
    toAmino(message) {
        ...
        obj.osmo_taker_fee_distribution = message.osmoTakerFeeDistribution ? exports.TakerFeeDistributionPercentage.toAmino(message.osmoTakerFeeDistribution) : undefined;
        obj.non_osmo_taker_fee_distribution = message.nonOsmoTakerFeeDistribution ? exports.TakerFeeDistributionPercentage.toAmino(message.nonOsmoTakerFeeDistribution) : undefined;
...
exports.TakerFeeDistributionPercentage = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.TakerFeeDistributionPercentage.typeUrl || typeof o.stakingRewards === "string" && typeof o.communityPool === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.TakerFeeDistributionPercentage.typeUrl || typeof o.staking_rewards === "string" && typeof o.community_pool === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.TakerFeeDistributionPercentage.typeUrl || typeof o.staking_rewards === "string" && typeof o.community_pool === "string");
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        ...
        if (message.communityPool !== "") {
            writer.uint32(18).string(math_1.Decimal.fromUserInput(message.communityPool, 18).atomics);
        }
        return writer;
    },
    decode(input, length) {
...
exports.TakerFeesTracker = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.TakerFeesTracker.typeUrl || Array.isArray(o.takerFeesToStakers) && (!o.takerFeesToStakers.length || coin_1.Coin.is(o.takerFeesToStakers[0])) && Array.isArray(o.takerFeesToCommunityPool) && (!o.takerFeesToCommunityPool.length || coin_1.Coin.is(o.takerFeesToCommunityPool[0])) && typeof o.heightAccountingStartsFrom === "bigint");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.TakerFeesTracker.typeUrl || Array.isArray(o.taker_fees_to_stakers) && (!o.taker_fees_to_stakers.length || coin_1.Coin.isSDK(o.taker_fees_to_stakers[0])) && Array.isArray(o.taker_fees_to_community_pool) && (!o.taker_fees_to_community_pool.length || coin_1.Coin.isSDK(o.taker_fees_to_community_pool[0])) && typeof o.height_accounting_starts_from === "bigint");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.TakerFeesTracker.typeUrl || Array.isArray(o.taker_fees_to_stakers) && (!o.taker_fees_to_stakers.length || coin_1.Coin.isAmino(o.taker_fees_to_stakers[0])) && Array.isArray(o.taker_fees_to_community_pool) && (!o.taker_fees_to_community_pool.length || coin_1.Coin.isAmino(o.taker_fees_to_community_pool[0])) && typeof o.height_accounting_starts_from === "bigint");
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromAmino(object) {
        const message = createBaseTakerFeesTracker();
        message.takerFeesToStakers = object.taker_fees_to_stakers?.map(e => coin_1.Coin.fromAmino(e)) || [];
        message.takerFeesToCommunityPool = object.taker_fees_to_community_pool?.map(e => coin_1.Coin.fromAmino(e)) || [];
...
exports.PoolVolume = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.PoolVolume.typeUrl || typeof o.poolId === "bigint" && Array.isArray(o.poolVolume) && (!o.poolVolume.length || coin_1.Coin.is(o.poolVolume[0])));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.PoolVolume.typeUrl || typeof o.pool_id === "bigint" && Array.isArray(o.pool_volume) && (!o.pool_volume.length || coin_1.Coin.isSDK(o.pool_volume[0])));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.PoolVolume.typeUrl || typeof o.pool_id === "bigint" && Array.isArray(o.pool_volume) && (!o.pool_volume.length || coin_1.Coin.isAmino(o.pool_volume[0])));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
