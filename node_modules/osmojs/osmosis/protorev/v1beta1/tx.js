...
exports.MsgSetHotRoutes = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.MsgSetHotRoutes.typeUrl || typeof o.admin === "string" && Array.isArray(o.hotRoutes) && (!o.hotRoutes.length || protorev_1.TokenPairArbRoutes.is(o.hotRoutes[0])));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.MsgSetHotRoutes.typeUrl || typeof o.admin === "string" && Array.isArray(o.hot_routes) && (!o.hot_routes.length || protorev_1.TokenPairArbRoutes.isSDK(o.hot_routes[0])));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.MsgSetHotRoutes.typeUrl || typeof o.admin === "string" && Array.isArray(o.hot_routes) && (!o.hot_routes.length || protorev_1.TokenPairArbRoutes.isAmino(o.hot_routes[0])));
    },
...
exports.MsgSetDeveloperAccount = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.MsgSetDeveloperAccount.typeUrl || typeof o.admin === "string" && typeof o.developerAccount === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.MsgSetDeveloperAccount.typeUrl || typeof o.admin === "string" && typeof o.developer_account === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.MsgSetDeveloperAccount.typeUrl || typeof o.admin === "string" && typeof o.developer_account === "string");
    },
...
exports.MsgSetInfoByPoolType = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.MsgSetInfoByPoolType.typeUrl || typeof o.admin === "string" && protorev_1.InfoByPoolType.is(o.infoByPoolType));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.MsgSetInfoByPoolType.typeUrl || typeof o.admin === "string" && protorev_1.InfoByPoolType.isSDK(o.info_by_pool_type));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.MsgSetInfoByPoolType.typeUrl || typeof o.admin === "string" && protorev_1.InfoByPoolType.isAmino(o.info_by_pool_type));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.admin !== "") {
            writer.uint32(10).string(message.admin);
...
exports.MsgSetMaxPoolPointsPerTx = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.MsgSetMaxPoolPointsPerTx.typeUrl || typeof o.admin === "string" && typeof o.maxPoolPointsPerTx === "bigint");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.MsgSetMaxPoolPointsPerTx.typeUrl || typeof o.admin === "string" && typeof o.max_pool_points_per_tx === "bigint");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.MsgSetMaxPoolPointsPerTx.typeUrl || typeof o.admin === "string" && typeof o.max_pool_points_per_tx === "bigint");
    },
...
exports.MsgSetMaxPoolPointsPerBlock = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.MsgSetMaxPoolPointsPerBlock.typeUrl || typeof o.admin === "string" && typeof o.maxPoolPointsPerBlock === "bigint");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.MsgSetMaxPoolPointsPerBlock.typeUrl || typeof o.admin === "string" && typeof o.max_pool_points_per_block === "bigint");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.MsgSetMaxPoolPointsPerBlock.typeUrl || typeof o.admin === "string" && typeof o.max_pool_points_per_block === "bigint");
    },
...
exports.MsgSetBaseDenoms = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.MsgSetBaseDenoms.typeUrl || typeof o.admin === "string" && Array.isArray(o.baseDenoms) && (!o.baseDenoms.length || protorev_1.BaseDenom.is(o.baseDenoms[0])));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.MsgSetBaseDenoms.typeUrl || typeof o.admin === "string" && Array.isArray(o.base_denoms) && (!o.base_denoms.length || protorev_1.BaseDenom.isSDK(o.base_denoms[0])));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.MsgSetBaseDenoms.typeUrl || typeof o.admin === "string" && Array.isArray(o.base_denoms) && (!o.base_denoms.length || protorev_1.BaseDenom.isAmino(o.base_denoms[0])));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.admin !== "") {
            writer.uint32(10).string(message.admin);
