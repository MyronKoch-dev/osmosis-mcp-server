...
exports.SetProtoRevEnabledProposal = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.SetProtoRevEnabledProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && typeof o.enabled === "boolean");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.SetProtoRevEnabledProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && typeof o.enabled === "boolean");
    },
...
exports.SetProtoRevAdminAccountProposal = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.SetProtoRevAdminAccountProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && typeof o.account === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.SetProtoRevAdminAccountProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && typeof o.account === "string");
    },
