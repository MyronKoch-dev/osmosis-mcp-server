...
exports.TokenPairArbRoutes = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.TokenPairArbRoutes.typeUrl || Array.isArray(o.arbRoutes) && (!o.arbRoutes.length || exports.Route.is(o.arbRoutes[0])) && typeof o.tokenIn === "string" && typeof o.tokenOut === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.TokenPairArbRoutes.typeUrl || Array.isArray(o.arb_routes) && (!o.arb_routes.length || exports.Route.isSDK(o.arb_routes[0])) && typeof o.token_in === "string" && typeof o.token_out === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.TokenPairArbRoutes.typeUrl || Array.isArray(o.arb_routes) && (!o.arb_routes.length || exports.Route.isAmino(o.arb_routes[0])) && typeof o.token_in === "string" && typeof o.token_out === "string");
    },
...
exports.Route = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.Route.typeUrl || Array.isArray(o.trades) && (!o.trades.length || exports.Trade.is(o.trades[0])) && typeof o.stepSize === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.Route.typeUrl || Array.isArray(o.trades) && (!o.trades.length || exports.Trade.isSDK(o.trades[0])) && typeof o.step_size === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.Route.typeUrl || Array.isArray(o.trades) && (!o.trades.length || exports.Trade.isAmino(o.trades[0])) && typeof o.step_size === "string");
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.Trade = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.Trade.typeUrl || typeof o.pool === "bigint" && typeof o.tokenIn === "string" && typeof o.tokenOut === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.Trade.typeUrl || typeof o.pool === "bigint" && typeof o.token_in === "string" && typeof o.token_out === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.Trade.typeUrl || typeof o.pool === "bigint" && typeof o.token_in === "string" && typeof o.token_out === "string");
    },
...
exports.RouteStatistics = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.RouteStatistics.typeUrl || Array.isArray(o.profits) && (!o.profits.length || coin_1.Coin.is(o.profits[0])) && typeof o.numberOfTrades === "string" && Array.isArray(o.route) && (!o.route.length || typeof o.route[0] === "bigint"));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.RouteStatistics.typeUrl || Array.isArray(o.profits) && (!o.profits.length || coin_1.Coin.isSDK(o.profits[0])) && typeof o.number_of_trades === "string" && Array.isArray(o.route) && (!o.route.length || typeof o.route[0] === "bigint"));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.RouteStatistics.typeUrl || Array.isArray(o.profits) && (!o.profits.length || coin_1.Coin.isAmino(o.profits[0])) && typeof o.number_of_trades === "string" && Array.isArray(o.route) && (!o.route.length || typeof o.route[0] === "bigint"));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.PoolWeights = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.PoolWeights.typeUrl || typeof o.stableWeight === "bigint" && typeof o.balancerWeight === "bigint" && typeof o.concentratedWeight === "bigint" && typeof o.cosmwasmWeight === "bigint");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.PoolWeights.typeUrl || typeof o.stable_weight === "bigint" && typeof o.balancer_weight === "bigint" && typeof o.concentrated_weight === "bigint" && typeof o.cosmwasm_weight === "bigint");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.PoolWeights.typeUrl || typeof o.stable_weight === "bigint" && typeof o.balancer_weight === "bigint" && typeof o.concentrated_weight === "bigint" && typeof o.cosmwasm_weight === "bigint");
    },
...
exports.InfoByPoolType = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.InfoByPoolType.typeUrl || exports.StablePoolInfo.is(o.stable) && exports.BalancerPoolInfo.is(o.balancer) && exports.ConcentratedPoolInfo.is(o.concentrated) && exports.CosmwasmPoolInfo.is(o.cosmwasm));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.InfoByPoolType.typeUrl || exports.StablePoolInfo.isSDK(o.stable) && exports.BalancerPoolInfo.isSDK(o.balancer) && exports.ConcentratedPoolInfo.isSDK(o.concentrated) && exports.CosmwasmPoolInfo.isSDK(o.cosmwasm));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.InfoByPoolType.typeUrl || exports.StablePoolInfo.isAmino(o.stable) && exports.BalancerPoolInfo.isAmino(o.balancer) && exports.ConcentratedPoolInfo.isAmino(o.concentrated) && exports.CosmwasmPoolInfo.isAmino(o.cosmwasm));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        const message = createBaseInfoByPoolType();
        message.stable = object.stable !== undefined && object.stable !== null ? exports.StablePoolInfo.fromPartial(object.stable) : undefined;
        message.balancer = object.balancer !== undefined && object.balancer !== null ? exports.BalancerPoolInfo.fromPartial(object.balancer) : undefined;
        message.concentrated = object.concentrated !== undefined && object.concentrated !== null ? exports.ConcentratedPoolInfo.fromPartial(object.concentrated) : undefined;
        message.cosmwasm = object.cosmwasm !== undefined && object.cosmwasm !== null ? exports.CosmwasmPoolInfo.fromPartial(object.cosmwasm) : undefined;
        return message;
    },
    fromAmino(object) {
        const message = createBaseInfoByPoolType();
    ...
    toAmino(message) {
        const obj = {};
        obj.stable = message.stable ? exports.StablePoolInfo.toAmino(message.stable) : undefined;
        obj.balancer = message.balancer ? exports.BalancerPoolInfo.toAmino(message.balancer) : undefined;
        obj.concentrated = message.concentrated ? exports.ConcentratedPoolInfo.toAmino(message.concentrated) : undefined;
        obj.cosmwasm = message.cosmwasm ? exports.CosmwasmPoolInfo.toAmino(message.cosmwasm) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.StablePoolInfo = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.StablePoolInfo.typeUrl || typeof o.weight === "bigint");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.StablePoolInfo.typeUrl || typeof o.weight === "bigint");
    },
...
exports.BalancerPoolInfo = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.BalancerPoolInfo.typeUrl || typeof o.weight === "bigint");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.BalancerPoolInfo.typeUrl || typeof o.weight === "bigint");
    },
...
exports.ConcentratedPoolInfo = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.ConcentratedPoolInfo.typeUrl || typeof o.weight === "bigint" && typeof o.maxTicksCrossed === "bigint");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.ConcentratedPoolInfo.typeUrl || typeof o.weight === "bigint" && typeof o.max_ticks_crossed === "bigint");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.ConcentratedPoolInfo.typeUrl || typeof o.weight === "bigint" && typeof o.max_ticks_crossed === "bigint");
    },
...
exports.CosmwasmPoolInfo = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.CosmwasmPoolInfo.typeUrl || Array.isArray(o.weightMaps) && (!o.weightMaps.length || exports.WeightMap.is(o.weightMaps[0])));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.CosmwasmPoolInfo.typeUrl || Array.isArray(o.weight_maps) && (!o.weight_maps.length || exports.WeightMap.isSDK(o.weight_maps[0])));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.CosmwasmPoolInfo.typeUrl || Array.isArray(o.weight_maps) && (!o.weight_maps.length || exports.WeightMap.isAmino(o.weight_maps[0])));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromAmino(object) {
        const message = createBaseCosmwasmPoolInfo();
        message.weightMaps = object.weight_maps?.map(e => exports.WeightMap.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.WeightMap = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.WeightMap.typeUrl || typeof o.weight === "bigint" && typeof o.contractAddress === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.WeightMap.typeUrl || typeof o.weight === "bigint" && typeof o.contract_address === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.WeightMap.typeUrl || typeof o.weight === "bigint" && typeof o.contract_address === "string");
    },
...
exports.BaseDenom = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.BaseDenom.typeUrl || typeof o.denom === "string" && typeof o.stepSize === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.BaseDenom.typeUrl || typeof o.denom === "string" && typeof o.step_size === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.BaseDenom.typeUrl || typeof o.denom === "string" && typeof o.step_size === "string");
    },
...
exports.BaseDenoms = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.BaseDenoms.typeUrl || Array.isArray(o.baseDenoms) && (!o.baseDenoms.length || exports.BaseDenom.is(o.baseDenoms[0])));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.BaseDenoms.typeUrl || Array.isArray(o.base_denoms) && (!o.base_denoms.length || exports.BaseDenom.isSDK(o.base_denoms[0])));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.BaseDenoms.typeUrl || Array.isArray(o.base_denoms) && (!o.base_denoms.length || exports.BaseDenom.isAmino(o.base_denoms[0])));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromAmino(object) {
        const message = createBaseBaseDenoms();
        message.baseDenoms = object.base_denoms?.map(e => exports.BaseDenom.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.AllProtocolRevenue = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.AllProtocolRevenue.typeUrl || genesis_1.TakerFeesTracker.is(o.takerFeesTracker) && exports.CyclicArbTracker.is(o.cyclicArbTracker));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.AllProtocolRevenue.typeUrl || genesis_1.TakerFeesTracker.isSDK(o.taker_fees_tracker) && exports.CyclicArbTracker.isSDK(o.cyclic_arb_tracker));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.AllProtocolRevenue.typeUrl || genesis_1.TakerFeesTracker.isAmino(o.taker_fees_tracker) && exports.CyclicArbTracker.isAmino(o.cyclic_arb_tracker));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        const message = createBaseAllProtocolRevenue();
        message.takerFeesTracker = object.takerFeesTracker !== undefined && object.takerFeesTracker !== null ? genesis_1.TakerFeesTracker.fromPartial(object.takerFeesTracker) : undefined;
        message.cyclicArbTracker = object.cyclicArbTracker !== undefined && object.cyclicArbTracker !== null ? exports.CyclicArbTracker.fromPartial(object.cyclicArbTracker) : undefined;
        return message;
    },
    fromAmino(object) {
        const message = createBaseAllProtocolRevenue();
    ...
    toAmino(message) {
        const obj = {};
        obj.taker_fees_tracker = message.takerFeesTracker ? genesis_1.TakerFeesTracker.toAmino(message.takerFeesTracker) : undefined;
        obj.cyclic_arb_tracker = message.cyclicArbTracker ? exports.CyclicArbTracker.toAmino(message.cyclicArbTracker) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.CyclicArbTracker = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.CyclicArbTracker.typeUrl || Array.isArray(o.cyclicArb) && (!o.cyclicArb.length || coin_1.Coin.is(o.cyclicArb[0])) && typeof o.heightAccountingStartsFrom === "bigint");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.CyclicArbTracker.typeUrl || Array.isArray(o.cyclic_arb) && (!o.cyclic_arb.length || coin_1.Coin.isSDK(o.cyclic_arb[0])) && typeof o.height_accounting_starts_from === "bigint");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.CyclicArbTracker.typeUrl || Array.isArray(o.cyclic_arb) && (!o.cyclic_arb.length || coin_1.Coin.isAmino(o.cyclic_arb[0])) && typeof o.height_accounting_starts_from === "bigint");
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
