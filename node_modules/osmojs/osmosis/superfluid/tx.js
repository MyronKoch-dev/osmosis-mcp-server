...
exports.MsgSuperfluidUndelegateAndUnbondLock = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.MsgSuperfluidUndelegateAndUnbondLock.typeUrl || typeof o.sender === "string" && typeof o.lockId === "bigint" && coin_1.Coin.is(o.coin));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.MsgSuperfluidUndelegateAndUnbondLock.typeUrl || typeof o.sender === "string" && typeof o.lock_id === "bigint" && coin_1.Coin.isSDK(o.coin));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.MsgSuperfluidUndelegateAndUnbondLock.typeUrl || typeof o.sender === "string" && typeof o.lock_id === "bigint" && coin_1.Coin.isAmino(o.coin));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.sender !== "") {
            writer.uint32(10).string(message.sender);
...
exports.MsgSuperfluidUndelegateAndUnbondLockResponse = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.MsgSuperfluidUndelegateAndUnbondLockResponse.typeUrl || typeof o.lockId === "bigint");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.MsgSuperfluidUndelegateAndUnbondLockResponse.typeUrl || typeof o.lock_id === "bigint");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.MsgSuperfluidUndelegateAndUnbondLockResponse.typeUrl || typeof o.lock_id === "bigint");
    },
...
exports.MsgCreateFullRangePositionAndSuperfluidDelegate = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.MsgCreateFullRangePositionAndSuperfluidDelegate.typeUrl || typeof o.sender === "string" && Array.isArray(o.coins) && (!o.coins.length || coin_1.Coin.is(o.coins[0])) && typeof o.valAddr === "string" && typeof o.poolId === "bigint");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.MsgCreateFullRangePositionAndSuperfluidDelegate.typeUrl || typeof o.sender === "string" && Array.isArray(o.coins) && (!o.coins.length || coin_1.Coin.isSDK(o.coins[0])) && typeof o.val_addr === "string" && typeof o.pool_id === "bigint");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.MsgCreateFullRangePositionAndSuperfluidDelegate.typeUrl || typeof o.sender === "string" && Array.isArray(o.coins) && (!o.coins.length || coin_1.Coin.isAmino(o.coins[0])) && typeof o.val_addr === "string" && typeof o.pool_id === "bigint");
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.sender !== "") {
            writer.uint32(10).string(message.sender);
...
exports.MsgCreateFullRangePositionAndSuperfluidDelegateResponse = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.MsgCreateFullRangePositionAndSuperfluidDelegateResponse.typeUrl || typeof o.lockID === "bigint" && typeof o.positionID === "bigint");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.MsgCreateFullRangePositionAndSuperfluidDelegateResponse.typeUrl || typeof o.lockID === "bigint" && typeof o.positionID === "bigint");
    },
...
exports.MsgUnlockAndMigrateSharesToFullRangeConcentratedPosition = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.MsgUnlockAndMigrateSharesToFullRangeConcentratedPosition.typeUrl || typeof o.sender === "string" && typeof o.lockId === "bigint" && coin_1.Coin.is(o.sharesToMigrate) && Array.isArray(o.tokenOutMins) && (!o.tokenOutMins.length || coin_1.Coin.is(o.tokenOutMins[0])));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.MsgUnlockAndMigrateSharesToFullRangeConcentratedPosition.typeUrl || typeof o.sender === "string" && typeof o.lock_id === "bigint" && coin_1.Coin.isSDK(o.shares_to_migrate) && Array.isArray(o.token_out_mins) && (!o.token_out_mins.length || coin_1.Coin.isSDK(o.token_out_mins[0])));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.MsgUnlockAndMigrateSharesToFullRangeConcentratedPosition.typeUrl || typeof o.sender === "string" && typeof o.lock_id === "bigint" && coin_1.Coin.isAmino(o.shares_to_migrate) && Array.isArray(o.token_out_mins) && (!o.token_out_mins.length || coin_1.Coin.isAmino(o.token_out_mins[0])));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.sender !== "") {
            writer.uint32(10).string(message.sender);
...
exports.MsgUnlockAndMigrateSharesToFullRangeConcentratedPositionResponse = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.MsgUnlockAndMigrateSharesToFullRangeConcentratedPositionResponse.typeUrl || typeof o.amount0 === "string" && typeof o.amount1 === "string" && typeof o.liquidityCreated === "string" && timestamp_1.Timestamp.is(o.joinTime));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.MsgUnlockAndMigrateSharesToFullRangeConcentratedPositionResponse.typeUrl || typeof o.amount0 === "string" && typeof o.amount1 === "string" && typeof o.liquidity_created === "string" && timestamp_1.Timestamp.isSDK(o.join_time));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.MsgUnlockAndMigrateSharesToFullRangeConcentratedPositionResponse.typeUrl || typeof o.amount0 === "string" && typeof o.amount1 === "string" && typeof o.liquidity_created === "string" && timestamp_1.Timestamp.isAmino(o.join_time));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.amount0 !== "") {
    ...
    toAmino(message) {
        ...
        obj.join_time = message.joinTime ? timestamp_1.Timestamp.toAmino((0, helpers_1.toTimestamp)(message.joinTime)) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.MsgAddToConcentratedLiquiditySuperfluidPosition = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.MsgAddToConcentratedLiquiditySuperfluidPosition.typeUrl || typeof o.positionId === "bigint" && typeof o.sender === "string" && coin_1.Coin.is(o.tokenDesired0) && coin_1.Coin.is(o.tokenDesired1));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.MsgAddToConcentratedLiquiditySuperfluidPosition.typeUrl || typeof o.position_id === "bigint" && typeof o.sender === "string" && coin_1.Coin.isSDK(o.token_desired0) && coin_1.Coin.isSDK(o.token_desired1));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.MsgAddToConcentratedLiquiditySuperfluidPosition.typeUrl || typeof o.position_id === "bigint" && typeof o.sender === "string" && coin_1.Coin.isAmino(o.token_desired0) && coin_1.Coin.isAmino(o.token_desired1));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.positionId !== BigInt(0)) {
...
exports.MsgAddToConcentratedLiquiditySuperfluidPositionResponse = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.MsgAddToConcentratedLiquiditySuperfluidPositionResponse.typeUrl || typeof o.positionId === "bigint" && typeof o.amount0 === "string" && typeof o.amount1 === "string" && typeof o.newLiquidity === "string" && typeof o.lockId === "bigint");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.MsgAddToConcentratedLiquiditySuperfluidPositionResponse.typeUrl || typeof o.position_id === "bigint" && typeof o.amount0 === "string" && typeof o.amount1 === "string" && typeof o.new_liquidity === "string" && typeof o.lock_id === "bigint");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.MsgAddToConcentratedLiquiditySuperfluidPositionResponse.typeUrl || typeof o.position_id === "bigint" && typeof o.amount0 === "string" && typeof o.amount1 === "string" && typeof o.new_liquidity === "string" && typeof o.lock_id === "bigint");
    },
...
exports.MsgUnbondConvertAndStake = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.MsgUnbondConvertAndStake.typeUrl || typeof o.lockId === "bigint" && typeof o.sender === "string" && typeof o.valAddr === "string" && typeof o.minAmtToStake === "string" && coin_1.Coin.is(o.sharesToConvert));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.MsgUnbondConvertAndStake.typeUrl || typeof o.lock_id === "bigint" && typeof o.sender === "string" && typeof o.val_addr === "string" && typeof o.min_amt_to_stake === "string" && coin_1.Coin.isSDK(o.shares_to_convert));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.MsgUnbondConvertAndStake.typeUrl || typeof o.lock_id === "bigint" && typeof o.sender === "string" && typeof o.val_addr === "string" && typeof o.min_amt_to_stake === "string" && coin_1.Coin.isAmino(o.shares_to_convert));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.lockId !== BigInt(0)) {
            writer.uint32(8).uint64(message.lockId);
    ...
    fromPartial(object) {
        ...
        message.sharesToConvert = object.sharesToConvert !== undefined && object.sharesToConvert !== null ? coin_1.Coin.fromPartial(object.sharesToConvert) : undefined;
        return message;
    },
    fromAmino(object) {
        const message = createBaseMsgUnbondConvertAndStake();
    ...
    toAmino(message) {
        ...
        obj.shares_to_convert = message.sharesToConvert ? coin_1.Coin.toAmino(message.sharesToConvert) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.MsgUnbondConvertAndStakeResponse = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.MsgUnbondConvertAndStakeResponse.typeUrl || typeof o.totalAmtStaked === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.MsgUnbondConvertAndStakeResponse.typeUrl || typeof o.total_amt_staked === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.MsgUnbondConvertAndStakeResponse.typeUrl || typeof o.total_amt_staked === "string");
    },
