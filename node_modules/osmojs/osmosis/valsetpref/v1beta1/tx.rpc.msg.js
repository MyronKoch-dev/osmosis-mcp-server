...
class MsgClientImpl {
    ...
    undelegateFromRebalancedValidatorSet(request) {
        const data = tx_1.MsgUndelegateFromRebalancedValidatorSet.encode(request).finish();
        const promise = this.rpc.request("osmosis.valsetpref.v1beta1.Msg", "UndelegateFromRebalancedValidatorSet", data);
        return promise.then(data => tx_1.MsgUndelegateFromRebalancedValidatorSetResponse.decode(new binary_1.BinaryReader(data)));
    }
