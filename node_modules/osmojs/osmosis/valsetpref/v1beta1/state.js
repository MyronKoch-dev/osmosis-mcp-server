...
exports.ValidatorPreference = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.ValidatorPreference.typeUrl || typeof o.valOperAddress === "string" && typeof o.weight === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.ValidatorPreference.typeUrl || typeof o.val_oper_address === "string" && typeof o.weight === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.ValidatorPreference.typeUrl || typeof o.val_oper_address === "string" && typeof o.weight === "string");
    },
...
registry_1.GlobalDecoderRegistry.register(exports.ValidatorPreference.typeUrl, exports.ValidatorPreference);
registry_1.GlobalDecoderRegistry.registerAminoProtoMapping(exports.ValidatorPreference.aminoType, exports.ValidatorPreference.typeUrl);
...
exports.ValidatorSetPreferences = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.ValidatorSetPreferences.typeUrl || Array.isArray(o.preferences) && (!o.preferences.length || exports.ValidatorPreference.is(o.preferences[0])));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.ValidatorSetPreferences.typeUrl || Array.isArray(o.preferences) && (!o.preferences.length || exports.ValidatorPreference.isSDK(o.preferences[0])));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.ValidatorSetPreferences.typeUrl || Array.isArray(o.preferences) && (!o.preferences.length || exports.ValidatorPreference.isAmino(o.preferences[0])));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
registry_1.GlobalDecoderRegistry.register(exports.ValidatorSetPreferences.typeUrl, exports.ValidatorSetPreferences);
registry_1.GlobalDecoderRegistry.registerAminoProtoMapping(exports.ValidatorSetPreferences.aminoType, exports.ValidatorSetPreferences.typeUrl);
