    ...
    return {
        ...
        osmosis: {
            concentratedliquidity: {
                v1beta1: (await Promise.resolve().then(() => __importStar(require("./concentratedliquidity/v1beta1/query.rpc.Query")))).createRpcQueryExtension(client)
            },
            cosmwasmpool: {
                v1beta1: (await Promise.resolve().then(() => __importStar(require("./cosmwasmpool/v1beta1/query.rpc.Query")))).createRpcQueryExtension(client)
            },
            downtimedetector: {
                v1beta1: (await Promise.resolve().then(() => __importStar(require("./downtimedetector/v1beta1/query.rpc.Query")))).createRpcQueryExtension(client)
            },
            epochs: {
                v1beta1: (await Promise.resolve().then(() => __importStar(require("./epochs/v1beta1/query.rpc.Query")))).createRpcQueryExtension(client)
            },
            gamm: {
            ...
            ibcratelimit: {
                v1beta1: (await Promise.resolve().then(() => __importStar(require("./ibcratelimit/v1beta1/query.rpc.Query")))).createRpcQueryExtension(client)
            },
            ...
            poolincentives: {
                v1beta1: (await Promise.resolve().then(() => __importStar(require("./poolincentives/v1beta1/query.rpc.Query")))).createRpcQueryExtension(client)
            },
            poolmanager: {
                v1beta1: (await Promise.resolve().then(() => __importStar(require("./poolmanager/v1beta1/query.rpc.Query")))).createRpcQueryExtension(client),
                v2: (await Promise.resolve().then(() => __importStar(require("./poolmanager/v2/query.rpc.Query")))).createRpcQueryExtension(client)
            },
            protorev: {
                v1beta1: (await Promise.resolve().then(() => __importStar(require("./protorev/v1beta1/query.rpc.Query")))).createRpcQueryExtension(client)
            },
            smartaccount: {
                v1beta1: (await Promise.resolve().then(() => __importStar(require("./smartaccount/v1beta1/query.rpc.Query")))).createRpcQueryExtension(client)
            },
            ...
            valsetpref: {
                v1beta1: (await Promise.resolve().then(() => __importStar(require("./valsetpref/v1beta1/query.rpc.Query")))).createRpcQueryExtension(client)
            }
        }
    };
};
