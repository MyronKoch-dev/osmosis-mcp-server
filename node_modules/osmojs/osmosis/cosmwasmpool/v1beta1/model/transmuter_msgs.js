...
exports.JoinPoolExecuteMsgRequest = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.JoinPoolExecuteMsgRequest.typeUrl || exports.EmptyRequest.is(o.joinPool));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.JoinPoolExecuteMsgRequest.typeUrl || exports.EmptyRequest.isSDK(o.join_pool));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.JoinPoolExecuteMsgRequest.typeUrl || exports.EmptyRequest.isAmino(o.join_pool));
    },
    ...
    fromPartial(object) {
        const message = createBaseJoinPoolExecuteMsgRequest();
        message.joinPool = object.joinPool !== undefined && object.joinPool !== null ? exports.EmptyRequest.fromPartial(object.joinPool) : undefined;
        return message;
    },
    fromAmino(object) {
        const message = createBaseJoinPoolExecuteMsgRequest();
    ...
    toAmino(message) {
        const obj = {};
        obj.join_pool = message.joinPool ? exports.EmptyRequest.toAmino(message.joinPool) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.ExitPoolExecuteMsgRequest = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.ExitPoolExecuteMsgRequest.typeUrl || exports.EmptyRequest.is(o.exitPool));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.ExitPoolExecuteMsgRequest.typeUrl || exports.EmptyRequest.isSDK(o.exit_pool));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.ExitPoolExecuteMsgRequest.typeUrl || exports.EmptyRequest.isAmino(o.exit_pool));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        const message = createBaseExitPoolExecuteMsgRequest();
        message.exitPool = object.exitPool !== undefined && object.exitPool !== null ? exports.EmptyRequest.fromPartial(object.exitPool) : undefined;
        return message;
    },
    fromAmino(object) {
        const message = createBaseExitPoolExecuteMsgRequest();
    ...
    toAmino(message) {
        const obj = {};
        obj.exit_pool = message.exitPool ? exports.EmptyRequest.toAmino(message.exitPool) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
