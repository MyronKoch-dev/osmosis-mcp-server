...
exports.InstantiateMsg = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.InstantiateMsg.typeUrl || Array.isArray(o.poolAssetDenoms) && (!o.poolAssetDenoms.length || typeof o.poolAssetDenoms[0] === "string"));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.InstantiateMsg.typeUrl || Array.isArray(o.pool_asset_denoms) && (!o.pool_asset_denoms.length || typeof o.pool_asset_denoms[0] === "string"));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.InstantiateMsg.typeUrl || Array.isArray(o.pool_asset_denoms) && (!o.pool_asset_denoms.length || typeof o.pool_asset_denoms[0] === "string"));
    },
