...
exports.GetSwapFeeQueryMsg = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.GetSwapFeeQueryMsg.typeUrl || exports.EmptyStruct.is(o.getSwapFee));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.GetSwapFeeQueryMsg.typeUrl || exports.EmptyStruct.isSDK(o.get_swap_fee));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.GetSwapFeeQueryMsg.typeUrl || exports.EmptyStruct.isAmino(o.get_swap_fee));
    },
    ...
    fromPartial(object) {
        const message = createBaseGetSwapFeeQueryMsg();
        message.getSwapFee = object.getSwapFee !== undefined && object.getSwapFee !== null ? exports.EmptyStruct.fromPartial(object.getSwapFee) : undefined;
        return message;
    },
    fromAmino(object) {
        const message = createBaseGetSwapFeeQueryMsg();
    ...
    toAmino(message) {
        const obj = {};
        obj.get_swap_fee = message.getSwapFee ? exports.EmptyStruct.toAmino(message.getSwapFee) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.GetSwapFeeQueryMsgResponse = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.GetSwapFeeQueryMsgResponse.typeUrl || typeof o.swapFee === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.GetSwapFeeQueryMsgResponse.typeUrl || typeof o.swap_fee === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.GetSwapFeeQueryMsgResponse.typeUrl || typeof o.swap_fee === "string");
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.swapFee !== "") {
            writer.uint32(26).string(math_1.Decimal.fromUserInput(message.swapFee, 18).atomics);
        }
        return writer;
    },
    decode(input, length) {
...
exports.SpotPrice = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.SpotPrice.typeUrl || typeof o.quoteAssetDenom === "string" && typeof o.baseAssetDenom === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.SpotPrice.typeUrl || typeof o.quote_asset_denom === "string" && typeof o.base_asset_denom === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.SpotPrice.typeUrl || typeof o.quote_asset_denom === "string" && typeof o.base_asset_denom === "string");
    },
...
exports.SpotPriceQueryMsg = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.SpotPriceQueryMsg.typeUrl || exports.SpotPrice.is(o.spotPrice));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.SpotPriceQueryMsg.typeUrl || exports.SpotPrice.isSDK(o.spot_price));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.SpotPriceQueryMsg.typeUrl || exports.SpotPrice.isAmino(o.spot_price));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        const message = createBaseSpotPriceQueryMsg();
        message.spotPrice = object.spotPrice !== undefined && object.spotPrice !== null ? exports.SpotPrice.fromPartial(object.spotPrice) : undefined;
        return message;
    },
    fromAmino(object) {
        const message = createBaseSpotPriceQueryMsg();
    ...
    toAmino(message) {
        const obj = {};
        obj.spot_price = message.spotPrice ? exports.SpotPrice.toAmino(message.spotPrice) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.SpotPriceQueryMsgResponse = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.SpotPriceQueryMsgResponse.typeUrl || typeof o.spotPrice === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.SpotPriceQueryMsgResponse.typeUrl || typeof o.spot_price === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.SpotPriceQueryMsgResponse.typeUrl || typeof o.spot_price === "string");
    },
...
exports.GetTotalPoolLiquidityQueryMsg = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.GetTotalPoolLiquidityQueryMsg.typeUrl || exports.EmptyStruct.is(o.getTotalPoolLiquidity));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.GetTotalPoolLiquidityQueryMsg.typeUrl || exports.EmptyStruct.isSDK(o.get_total_pool_liquidity));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.GetTotalPoolLiquidityQueryMsg.typeUrl || exports.EmptyStruct.isAmino(o.get_total_pool_liquidity));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        const message = createBaseGetTotalPoolLiquidityQueryMsg();
        message.getTotalPoolLiquidity = object.getTotalPoolLiquidity !== undefined && object.getTotalPoolLiquidity !== null ? exports.EmptyStruct.fromPartial(object.getTotalPoolLiquidity) : undefined;
        return message;
    },
    fromAmino(object) {
        const message = createBaseGetTotalPoolLiquidityQueryMsg();
    ...
    toAmino(message) {
        const obj = {};
        obj.get_total_pool_liquidity = message.getTotalPoolLiquidity ? exports.EmptyStruct.toAmino(message.getTotalPoolLiquidity) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.GetTotalPoolLiquidityQueryMsgResponse = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.GetTotalPoolLiquidityQueryMsgResponse.typeUrl || Array.isArray(o.totalPoolLiquidity) && (!o.totalPoolLiquidity.length || coin_1.Coin.is(o.totalPoolLiquidity[0])));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.GetTotalPoolLiquidityQueryMsgResponse.typeUrl || Array.isArray(o.total_pool_liquidity) && (!o.total_pool_liquidity.length || coin_1.Coin.isSDK(o.total_pool_liquidity[0])));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.GetTotalPoolLiquidityQueryMsgResponse.typeUrl || Array.isArray(o.total_pool_liquidity) && (!o.total_pool_liquidity.length || coin_1.Coin.isAmino(o.total_pool_liquidity[0])));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromAmino(object) {
        const message = createBaseGetTotalPoolLiquidityQueryMsgResponse();
        message.totalPoolLiquidity = object.total_pool_liquidity?.map(e => coin_1.Coin.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.GetTotalSharesQueryMsg = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.GetTotalSharesQueryMsg.typeUrl || exports.EmptyStruct.is(o.getTotalShares));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.GetTotalSharesQueryMsg.typeUrl || exports.EmptyStruct.isSDK(o.get_total_shares));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.GetTotalSharesQueryMsg.typeUrl || exports.EmptyStruct.isAmino(o.get_total_shares));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        const message = createBaseGetTotalSharesQueryMsg();
        message.getTotalShares = object.getTotalShares !== undefined && object.getTotalShares !== null ? exports.EmptyStruct.fromPartial(object.getTotalShares) : undefined;
        return message;
    },
    fromAmino(object) {
        const message = createBaseGetTotalSharesQueryMsg();
    ...
    toAmino(message) {
        const obj = {};
        obj.get_total_shares = message.getTotalShares ? exports.EmptyStruct.toAmino(message.getTotalShares) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.GetTotalSharesQueryMsgResponse = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.GetTotalSharesQueryMsgResponse.typeUrl || typeof o.totalShares === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.GetTotalSharesQueryMsgResponse.typeUrl || typeof o.total_shares === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.GetTotalSharesQueryMsgResponse.typeUrl || typeof o.total_shares === "string");
    },
