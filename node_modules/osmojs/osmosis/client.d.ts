...
export declare const osmosisAminoConverters: {
    ...
    "/osmosis.txfees.v1beta1.MsgSetFeeTokens": {
        aminoType: string;
        toAmino: (message: import("./txfees/v1beta1/tx").MsgSetFeeTokens) => import("./txfees/v1beta1/tx").MsgSetFeeTokensAmino;
        fromAmino: (object: import("./txfees/v1beta1/tx").MsgSetFeeTokensAmino) => import("./txfees/v1beta1/tx").MsgSetFeeTokens;
    };
    ...
    "/osmosis.smartaccount.v1beta1.MsgAddAuthenticator": {
        aminoType: string;
        toAmino: (message: import("./smartaccount/v1beta1/tx").MsgAddAuthenticator) => import("./smartaccount/v1beta1/tx").MsgAddAuthenticatorAmino;
        fromAmino: (object: import("./smartaccount/v1beta1/tx").MsgAddAuthenticatorAmino) => import("./smartaccount/v1beta1/tx").MsgAddAuthenticator;
    };
    "/osmosis.smartaccount.v1beta1.MsgRemoveAuthenticator": {
        aminoType: string;
        toAmino: (message: import("./smartaccount/v1beta1/tx").MsgRemoveAuthenticator) => import("./smartaccount/v1beta1/tx").MsgRemoveAuthenticatorAmino;
        fromAmino: (object: import("./smartaccount/v1beta1/tx").MsgRemoveAuthenticatorAmino) => import("./smartaccount/v1beta1/tx").MsgRemoveAuthenticator;
    };
    "/osmosis.smartaccount.v1beta1.MsgSetActiveState": {
        aminoType: string;
        toAmino: (message: import("./smartaccount/v1beta1/tx").MsgSetActiveState) => import("./smartaccount/v1beta1/tx").MsgSetActiveStateAmino;
        fromAmino: (object: import("./smartaccount/v1beta1/tx").MsgSetActiveStateAmino) => import("./smartaccount/v1beta1/tx").MsgSetActiveState;
    };
