...
class QueryClientImpl {
    ...
    cFMMConcentratedPoolLinks(request = {}) {
        const data = query_1.QueryCFMMConcentratedPoolLinksRequest.encode(request).finish();
        const promise = this.rpc.request("osmosis.gamm.v1beta1.Query", "CFMMConcentratedPoolLinks", data);
        return promise.then(data => query_1.QueryCFMMConcentratedPoolLinksResponse.decode(new binary_1.BinaryReader(data)));
    }
}
