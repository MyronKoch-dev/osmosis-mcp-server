...
exports.MigrationRecords = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.MigrationRecords.typeUrl || Array.isArray(o.balancerToConcentratedPoolLinks) && (!o.balancerToConcentratedPoolLinks.length || exports.BalancerToConcentratedPoolLink.is(o.balancerToConcentratedPoolLinks[0])));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.MigrationRecords.typeUrl || Array.isArray(o.balancer_to_concentrated_pool_links) && (!o.balancer_to_concentrated_pool_links.length || exports.BalancerToConcentratedPoolLink.isSDK(o.balancer_to_concentrated_pool_links[0])));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.MigrationRecords.typeUrl || Array.isArray(o.balancer_to_concentrated_pool_links) && (!o.balancer_to_concentrated_pool_links.length || exports.BalancerToConcentratedPoolLink.isAmino(o.balancer_to_concentrated_pool_links[0])));
    },
    ...
    fromPartial(object) {
        const message = createBaseMigrationRecords();
        message.balancerToConcentratedPoolLinks = object.balancerToConcentratedPoolLinks?.map(e => exports.BalancerToConcentratedPoolLink.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseMigrationRecords();
        message.balancerToConcentratedPoolLinks = object.balancer_to_concentrated_pool_links?.map(e => exports.BalancerToConcentratedPoolLink.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
        if (message.balancerToConcentratedPoolLinks) {
            obj.balancer_to_concentrated_pool_links = message.balancerToConcentratedPoolLinks.map(e => e ? exports.BalancerToConcentratedPoolLink.toAmino(e) : undefined);
        }
        else {
...
exports.BalancerToConcentratedPoolLink = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.BalancerToConcentratedPoolLink.typeUrl || typeof o.balancerPoolId === "bigint" && typeof o.clPoolId === "bigint");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.BalancerToConcentratedPoolLink.typeUrl || typeof o.balancer_pool_id === "bigint" && typeof o.cl_pool_id === "bigint");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.BalancerToConcentratedPoolLink.typeUrl || typeof o.balancer_pool_id === "bigint" && typeof o.cl_pool_id === "bigint");
    },
