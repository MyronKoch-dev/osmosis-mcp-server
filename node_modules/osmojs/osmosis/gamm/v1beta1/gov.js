...
exports.ReplaceMigrationRecordsProposal = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.ReplaceMigrationRecordsProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && Array.isArray(o.records) && (!o.records.length || shared_1.BalancerToConcentratedPoolLink.is(o.records[0])));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.ReplaceMigrationRecordsProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && Array.isArray(o.records) && (!o.records.length || shared_1.BalancerToConcentratedPoolLink.isSDK(o.records[0])));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.ReplaceMigrationRecordsProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && Array.isArray(o.records) && (!o.records.length || shared_1.BalancerToConcentratedPoolLink.isAmino(o.records[0])));
    },
    ...
    fromAmino(object) {
        ...
        message.records = object.records?.map(e => shared_1.BalancerToConcentratedPoolLink.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.UpdateMigrationRecordsProposal = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.UpdateMigrationRecordsProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && Array.isArray(o.records) && (!o.records.length || shared_1.BalancerToConcentratedPoolLink.is(o.records[0])));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.UpdateMigrationRecordsProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && Array.isArray(o.records) && (!o.records.length || shared_1.BalancerToConcentratedPoolLink.isSDK(o.records[0])));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.UpdateMigrationRecordsProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && Array.isArray(o.records) && (!o.records.length || shared_1.BalancerToConcentratedPoolLink.isAmino(o.records[0])));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.title !== "") {
            writer.uint32(10).string(message.title);
...
exports.PoolRecordWithCFMMLink = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.PoolRecordWithCFMMLink.typeUrl || typeof o.denom0 === "string" && typeof o.denom1 === "string" && typeof o.tickSpacing === "bigint" && typeof o.exponentAtPriceOne === "string" && typeof o.spreadFactor === "string" && typeof o.balancerPoolId === "bigint");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.PoolRecordWithCFMMLink.typeUrl || typeof o.denom0 === "string" && typeof o.denom1 === "string" && typeof o.tick_spacing === "bigint" && typeof o.exponent_at_price_one === "string" && typeof o.spread_factor === "string" && typeof o.balancer_pool_id === "bigint");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.PoolRecordWithCFMMLink.typeUrl || typeof o.denom0 === "string" && typeof o.denom1 === "string" && typeof o.tick_spacing === "bigint" && typeof o.exponent_at_price_one === "string" && typeof o.spread_factor === "string" && typeof o.balancer_pool_id === "bigint");
    },
...
exports.CreateConcentratedLiquidityPoolsAndLinktoCFMMProposal = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.CreateConcentratedLiquidityPoolsAndLinktoCFMMProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && Array.isArray(o.poolRecordsWithCfmmLink) && (!o.poolRecordsWithCfmmLink.length || exports.PoolRecordWithCFMMLink.is(o.poolRecordsWithCfmmLink[0])));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.CreateConcentratedLiquidityPoolsAndLinktoCFMMProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && Array.isArray(o.pool_records_with_cfmm_link) && (!o.pool_records_with_cfmm_link.length || exports.PoolRecordWithCFMMLink.isSDK(o.pool_records_with_cfmm_link[0])));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.CreateConcentratedLiquidityPoolsAndLinktoCFMMProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && Array.isArray(o.pool_records_with_cfmm_link) && (!o.pool_records_with_cfmm_link.length || exports.PoolRecordWithCFMMLink.isAmino(o.pool_records_with_cfmm_link[0])));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.title !== "") {
            writer.uint32(10).string(message.title);
    ...
    fromPartial(object) {
        ...
        message.title = object.title ?? "";
        message.description = object.description ?? "";
        message.poolRecordsWithCfmmLink = object.poolRecordsWithCfmmLink?.map(e => exports.PoolRecordWithCFMMLink.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseCreateConcentratedLiquidityPoolsAndLinktoCFMMProposal();
        ...
        message.poolRecordsWithCfmmLink = object.pool_records_with_cfmm_link?.map(e => exports.PoolRecordWithCFMMLink.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.SetScalingFactorControllerProposal = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.SetScalingFactorControllerProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && typeof o.poolId === "bigint" && typeof o.controllerAddress === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.SetScalingFactorControllerProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && typeof o.pool_id === "bigint" && typeof o.controller_address === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.SetScalingFactorControllerProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && typeof o.pool_id === "bigint" && typeof o.controller_address === "string");
    },
