...
exports.Params = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.Params.typeUrl || typeof o.maximumUnauthenticatedGas === "bigint" && typeof o.isSmartAccountActive === "boolean" && Array.isArray(o.circuitBreakerControllers) && (!o.circuitBreakerControllers.length || typeof o.circuitBreakerControllers[0] === "string"));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.Params.typeUrl || typeof o.maximum_unauthenticated_gas === "bigint" && typeof o.is_smart_account_active === "boolean" && Array.isArray(o.circuit_breaker_controllers) && (!o.circuit_breaker_controllers.length || typeof o.circuit_breaker_controllers[0] === "string"));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.Params.typeUrl || typeof o.maximum_unauthenticated_gas === "bigint" && typeof o.is_smart_account_active === "boolean" && Array.isArray(o.circuit_breaker_controllers) && (!o.circuit_breaker_controllers.length || typeof o.circuit_breaker_controllers[0] === "string"));
    },
