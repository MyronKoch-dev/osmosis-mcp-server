...
exports.ConcentratedPoolToNoLockGauges = exports.AnyPoolToInternalGauges = exports.PoolToGauge = exports.DistrRecord = exports.DistrInfo = exports.LockableDurationsInfo = exports.Params = void 0;
//@ts-nocheck
...
exports.AnyPoolToInternalGauges = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.AnyPoolToInternalGauges.typeUrl || Array.isArray(o.poolToGauge) && (!o.poolToGauge.length || exports.PoolToGauge.is(o.poolToGauge[0])));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.AnyPoolToInternalGauges.typeUrl || Array.isArray(o.pool_to_gauge) && (!o.pool_to_gauge.length || exports.PoolToGauge.isSDK(o.pool_to_gauge[0])));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.AnyPoolToInternalGauges.typeUrl || Array.isArray(o.pool_to_gauge) && (!o.pool_to_gauge.length || exports.PoolToGauge.isAmino(o.pool_to_gauge[0])));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromAminoMsg(object) {
        return exports.AnyPoolToInternalGauges.fromAmino(object.value);
    },
    toAminoMsg(message) {
        return {
            type: "osmosis/poolincentives/any-pool-to-internal-gauges",
            value: exports.AnyPoolToInternalGauges.toAmino(message)
        };
    },
    fromProtoMsg(message) {
        return exports.AnyPoolToInternalGauges.decode(message.value);
    },
    toProto(message) {
        return exports.AnyPoolToInternalGauges.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/osmosis.poolincentives.v1beta1.AnyPoolToInternalGauges",
            value: exports.AnyPoolToInternalGauges.encode(message).finish()
        };
    }
};
registry_1.GlobalDecoderRegistry.register(exports.AnyPoolToInternalGauges.typeUrl, exports.AnyPoolToInternalGauges);
registry_1.GlobalDecoderRegistry.registerAminoProtoMapping(exports.AnyPoolToInternalGauges.aminoType, exports.AnyPoolToInternalGauges.typeUrl);
...
exports.ConcentratedPoolToNoLockGauges = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.ConcentratedPoolToNoLockGauges.typeUrl || Array.isArray(o.poolToGauge) && (!o.poolToGauge.length || exports.PoolToGauge.is(o.poolToGauge[0])));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.ConcentratedPoolToNoLockGauges.typeUrl || Array.isArray(o.pool_to_gauge) && (!o.pool_to_gauge.length || exports.PoolToGauge.isSDK(o.pool_to_gauge[0])));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.ConcentratedPoolToNoLockGauges.typeUrl || Array.isArray(o.pool_to_gauge) && (!o.pool_to_gauge.length || exports.PoolToGauge.isAmino(o.pool_to_gauge[0])));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        for (const v of message.poolToGauge) {
    ...
    fromAminoMsg(object) {
        return exports.ConcentratedPoolToNoLockGauges.fromAmino(object.value);
    },
    toAminoMsg(message) {
        return {
            type: "osmosis/poolincentives/concentrated-pool-to-no-lock-gauges",
            value: exports.ConcentratedPoolToNoLockGauges.toAmino(message)
        };
    },
    fromProtoMsg(message) {
        return exports.ConcentratedPoolToNoLockGauges.decode(message.value);
    },
    toProto(message) {
        return exports.ConcentratedPoolToNoLockGauges.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/osmosis.poolincentives.v1beta1.ConcentratedPoolToNoLockGauges",
            value: exports.ConcentratedPoolToNoLockGauges.encode(message).finish()
        };
    }
};
registry_1.GlobalDecoderRegistry.register(exports.ConcentratedPoolToNoLockGauges.typeUrl, exports.ConcentratedPoolToNoLockGauges);
registry_1.GlobalDecoderRegistry.registerAminoProtoMapping(exports.ConcentratedPoolToNoLockGauges.aminoType, exports.ConcentratedPoolToNoLockGauges.typeUrl);
