...
exports.GenesisState = {
    ...
    fromPartial(object) {
        ...
        message.anyPoolToInternalGauges = object.anyPoolToInternalGauges !== undefined && object.anyPoolToInternalGauges !== null ? incentives_1.AnyPoolToInternalGauges.fromPartial(object.anyPoolToInternalGauges) : undefined;
        message.concentratedPoolToNoLockGauges = object.concentratedPoolToNoLockGauges !== undefined && object.concentratedPoolToNoLockGauges !== null ? incentives_1.ConcentratedPoolToNoLockGauges.fromPartial(object.concentratedPoolToNoLockGauges) : undefined;
        return message;
    },
    fromAmino(object) {
        const message = createBaseGenesisState();
        ...
        if (object.concentrated_pool_to_no_lock_gauges !== undefined && object.concentrated_pool_to_no_lock_gauges !== null) {
            message.concentratedPoolToNoLockGauges = incentives_1.ConcentratedPoolToNoLockGauges.fromAmino(object.concentrated_pool_to_no_lock_gauges);
        }
        return message;
    },
    toAmino(message) {
        ...
        obj.any_pool_to_internal_gauges = message.anyPoolToInternalGauges ? incentives_1.AnyPoolToInternalGauges.toAmino(message.anyPoolToInternalGauges) : undefined;
        obj.concentrated_pool_to_no_lock_gauges = message.concentratedPoolToNoLockGauges ? incentives_1.ConcentratedPoolToNoLockGauges.toAmino(message.concentratedPoolToNoLockGauges) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
