...
const createRPCMsgClient = async ({ rpc }) => ({
    ...
    osmosis: {
        ...
        smartaccount: {
            v1beta1: new (await Promise.resolve().then(() => __importStar(require("./smartaccount/v1beta1/tx.rpc.msg")))).MsgClientImpl(rpc)
        },
        ...
        txfees: {
            v1beta1: new (await Promise.resolve().then(() => __importStar(require("./txfees/v1beta1/tx.rpc.msg")))).MsgClientImpl(rpc)
        },
        valsetpref: {
