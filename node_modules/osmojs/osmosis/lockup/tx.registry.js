...
exports.registry = [["/osmosis.lockup.MsgLockTokens", tx_1.MsgLockTokens], ["/osmosis.lockup.MsgBeginUnlockingAll", tx_1.MsgBeginUnlockingAll], ["/osmosis.lockup.MsgBeginUnlocking", tx_1.MsgBeginUnlocking], ["/osmosis.lockup.MsgExtendLockup", tx_1.MsgExtendLockup], ["/osmosis.lockup.MsgForceUnlock", tx_1.MsgForceUnlock], ["/osmosis.lockup.MsgSetRewardReceiverAddress", tx_1.MsgSetRewardReceiverAddress]];
...
exports.MessageComposer = {
    encoded: {
        ...
        setRewardReceiverAddress(value) {
            return {
                ...
                value: tx_1.MsgSetRewardReceiverAddress.encode(value).finish()
            };
        }
    },
    withTypeUrl: {
    ...
    fromPartial: {
        ...
        setRewardReceiverAddress(value) {
            return {
                typeUrl: "/osmosis.lockup.MsgSetRewardReceiverAddress",
                value: tx_1.MsgSetRewardReceiverAddress.fromPartial(value)
            };
        }
    }
};
