...
exports.PeriodLock = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.PeriodLock.typeUrl || typeof o.ID === "bigint" && typeof o.owner === "string" && duration_1.Duration.is(o.duration) && timestamp_1.Timestamp.is(o.endTime) && Array.isArray(o.coins) && (!o.coins.length || coin_1.Coin.is(o.coins[0])) && typeof o.rewardReceiverAddress === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.PeriodLock.typeUrl || typeof o.ID === "bigint" && typeof o.owner === "string" && duration_1.Duration.isSDK(o.duration) && timestamp_1.Timestamp.isSDK(o.end_time) && Array.isArray(o.coins) && (!o.coins.length || coin_1.Coin.isSDK(o.coins[0])) && typeof o.reward_receiver_address === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.PeriodLock.typeUrl || typeof o.ID === "bigint" && typeof o.owner === "string" && duration_1.Duration.isAmino(o.duration) && timestamp_1.Timestamp.isAmino(o.end_time) && Array.isArray(o.coins) && (!o.coins.length || coin_1.Coin.isAmino(o.coins[0])) && typeof o.reward_receiver_address === "string");
    },
