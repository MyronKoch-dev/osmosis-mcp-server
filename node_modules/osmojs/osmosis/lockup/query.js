...
exports.LockRewardReceiverRequest = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.LockRewardReceiverRequest.typeUrl || typeof o.lockId === "bigint");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.LockRewardReceiverRequest.typeUrl || typeof o.lock_id === "bigint");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.LockRewardReceiverRequest.typeUrl || typeof o.lock_id === "bigint");
    },
    ...
    fromAminoMsg(object) {
        return exports.LockRewardReceiverRequest.fromAmino(object.value);
    },
    toAminoMsg(message) {
        return {
            type: "osmosis/lockup/lock-reward-receiver-request",
            value: exports.LockRewardReceiverRequest.toAmino(message)
        };
    },
    fromProtoMsg(message) {
        return exports.LockRewardReceiverRequest.decode(message.value);
    },
    toProto(message) {
        return exports.LockRewardReceiverRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/osmosis.lockup.LockRewardReceiverRequest",
            value: exports.LockRewardReceiverRequest.encode(message).finish()
        };
    }
};
registry_1.GlobalDecoderRegistry.register(exports.LockRewardReceiverRequest.typeUrl, exports.LockRewardReceiverRequest);
registry_1.GlobalDecoderRegistry.registerAminoProtoMapping(exports.LockRewardReceiverRequest.aminoType, exports.LockRewardReceiverRequest.typeUrl);
...
exports.LockRewardReceiverResponse = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.LockRewardReceiverResponse.typeUrl || typeof o.rewardReceiver === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.LockRewardReceiverResponse.typeUrl || typeof o.reward_receiver === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.LockRewardReceiverResponse.typeUrl || typeof o.reward_receiver === "string");
    },
    ...
    fromAminoMsg(object) {
        return exports.LockRewardReceiverResponse.fromAmino(object.value);
    },
    toAminoMsg(message) {
        return {
            type: "osmosis/lockup/lock-reward-receiver-response",
            value: exports.LockRewardReceiverResponse.toAmino(message)
        };
    },
    fromProtoMsg(message) {
        return exports.LockRewardReceiverResponse.decode(message.value);
    },
    toProto(message) {
        return exports.LockRewardReceiverResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/osmosis.lockup.LockRewardReceiverResponse",
            value: exports.LockRewardReceiverResponse.encode(message).finish()
        };
    }
};
registry_1.GlobalDecoderRegistry.register(exports.LockRewardReceiverResponse.typeUrl, exports.LockRewardReceiverResponse);
registry_1.GlobalDecoderRegistry.registerAminoProtoMapping(exports.LockRewardReceiverResponse.aminoType, exports.LockRewardReceiverResponse.typeUrl);
...
exports.NextLockIDRequest = {
    ...
    is(o) {
        return o && o.$typeUrl === exports.NextLockIDRequest.typeUrl;
    },
    isSDK(o) {
        return o && o.$typeUrl === exports.NextLockIDRequest.typeUrl;
    },
    ...
    fromAminoMsg(object) {
        return exports.NextLockIDRequest.fromAmino(object.value);
    },
    toAminoMsg(message) {
        return {
            type: "osmosis/lockup/next-lock-id-request",
            value: exports.NextLockIDRequest.toAmino(message)
        };
    },
    fromProtoMsg(message) {
        return exports.NextLockIDRequest.decode(message.value);
    },
    toProto(message) {
        return exports.NextLockIDRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/osmosis.lockup.NextLockIDRequest",
            value: exports.NextLockIDRequest.encode(message).finish()
        };
    }
};
registry_1.GlobalDecoderRegistry.register(exports.NextLockIDRequest.typeUrl, exports.NextLockIDRequest);
registry_1.GlobalDecoderRegistry.registerAminoProtoMapping(exports.NextLockIDRequest.aminoType, exports.NextLockIDRequest.typeUrl);
...
exports.NextLockIDResponse = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.NextLockIDResponse.typeUrl || typeof o.lockId === "bigint");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.NextLockIDResponse.typeUrl || typeof o.lock_id === "bigint");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.NextLockIDResponse.typeUrl || typeof o.lock_id === "bigint");
    },
    ...
    fromAminoMsg(object) {
        return exports.NextLockIDResponse.fromAmino(object.value);
    },
    toAminoMsg(message) {
        return {
            type: "osmosis/lockup/next-lock-id-response",
            value: exports.NextLockIDResponse.toAmino(message)
        };
    },
    fromProtoMsg(message) {
        return exports.NextLockIDResponse.decode(message.value);
    },
    toProto(message) {
        return exports.NextLockIDResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/osmosis.lockup.NextLockIDResponse",
            value: exports.NextLockIDResponse.encode(message).finish()
        };
    }
};
registry_1.GlobalDecoderRegistry.register(exports.NextLockIDResponse.typeUrl, exports.NextLockIDResponse);
registry_1.GlobalDecoderRegistry.registerAminoProtoMapping(exports.NextLockIDResponse.aminoType, exports.NextLockIDResponse.typeUrl);
...
exports.SyntheticLockupByLockupIDRequest = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.SyntheticLockupByLockupIDRequest.typeUrl || typeof o.lockId === "bigint");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.SyntheticLockupByLockupIDRequest.typeUrl || typeof o.lock_id === "bigint");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.SyntheticLockupByLockupIDRequest.typeUrl || typeof o.lock_id === "bigint");
    },
    ...
    fromAminoMsg(object) {
        return exports.SyntheticLockupByLockupIDRequest.fromAmino(object.value);
    },
    toAminoMsg(message) {
        return {
            type: "osmosis/lockup/synthetic-lockup-by-lockup-id-request",
            value: exports.SyntheticLockupByLockupIDRequest.toAmino(message)
        };
    },
    fromProtoMsg(message) {
        return exports.SyntheticLockupByLockupIDRequest.decode(message.value);
    },
    toProto(message) {
        return exports.SyntheticLockupByLockupIDRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/osmosis.lockup.SyntheticLockupByLockupIDRequest",
            value: exports.SyntheticLockupByLockupIDRequest.encode(message).finish()
        };
    }
};
registry_1.GlobalDecoderRegistry.register(exports.SyntheticLockupByLockupIDRequest.typeUrl, exports.SyntheticLockupByLockupIDRequest);
registry_1.GlobalDecoderRegistry.registerAminoProtoMapping(exports.SyntheticLockupByLockupIDRequest.aminoType, exports.SyntheticLockupByLockupIDRequest.typeUrl);
...
exports.SyntheticLockupByLockupIDResponse = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.SyntheticLockupByLockupIDResponse.typeUrl || lock_1.SyntheticLock.is(o.syntheticLock));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.SyntheticLockupByLockupIDResponse.typeUrl || lock_1.SyntheticLock.isSDK(o.synthetic_lock));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.SyntheticLockupByLockupIDResponse.typeUrl || lock_1.SyntheticLock.isAmino(o.synthetic_lock));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromPartial(object) {
        const message = createBaseSyntheticLockupByLockupIDResponse();
        message.syntheticLock = object.syntheticLock !== undefined && object.syntheticLock !== null ? lock_1.SyntheticLock.fromPartial(object.syntheticLock) : undefined;
        return message;
    },
    fromAmino(object) {
        const message = createBaseSyntheticLockupByLockupIDResponse();
    ...
    toAmino(message) {
        const obj = {};
        obj.synthetic_lock = message.syntheticLock ? lock_1.SyntheticLock.toAmino(message.syntheticLock) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
        return exports.SyntheticLockupByLockupIDResponse.fromAmino(object.value);
    },
    toAminoMsg(message) {
        return {
            type: "osmosis/lockup/synthetic-lockup-by-lockup-id-response",
            value: exports.SyntheticLockupByLockupIDResponse.toAmino(message)
        };
    },
    fromProtoMsg(message) {
        return exports.SyntheticLockupByLockupIDResponse.decode(message.value);
    },
    toProto(message) {
        return exports.SyntheticLockupByLockupIDResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/osmosis.lockup.SyntheticLockupByLockupIDResponse",
            value: exports.SyntheticLockupByLockupIDResponse.encode(message).finish()
        };
    }
};
registry_1.GlobalDecoderRegistry.register(exports.SyntheticLockupByLockupIDResponse.typeUrl, exports.SyntheticLockupByLockupIDResponse);
registry_1.GlobalDecoderRegistry.registerAminoProtoMapping(exports.SyntheticLockupByLockupIDResponse.aminoType, exports.SyntheticLockupByLockupIDResponse.typeUrl);
