...
exports.MsgCreateConcentratedPool = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.MsgCreateConcentratedPool.typeUrl || typeof o.sender === "string" && typeof o.denom0 === "string" && typeof o.denom1 === "string" && typeof o.tickSpacing === "bigint" && typeof o.spreadFactor === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.MsgCreateConcentratedPool.typeUrl || typeof o.sender === "string" && typeof o.denom0 === "string" && typeof o.denom1 === "string" && typeof o.tick_spacing === "bigint" && typeof o.spread_factor === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.MsgCreateConcentratedPool.typeUrl || typeof o.sender === "string" && typeof o.denom0 === "string" && typeof o.denom1 === "string" && typeof o.tick_spacing === "bigint" && typeof o.spread_factor === "string");
    },
...
exports.MsgCreateConcentratedPoolResponse = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.MsgCreateConcentratedPoolResponse.typeUrl || typeof o.poolId === "bigint");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.MsgCreateConcentratedPoolResponse.typeUrl || typeof o.pool_id === "bigint");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.MsgCreateConcentratedPoolResponse.typeUrl || typeof o.pool_id === "bigint");
    },
