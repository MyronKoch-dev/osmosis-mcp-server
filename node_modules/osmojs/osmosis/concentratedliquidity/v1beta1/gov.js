...
exports.CreateConcentratedLiquidityPoolsProposal = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.CreateConcentratedLiquidityPoolsProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && Array.isArray(o.poolRecords) && (!o.poolRecords.length || exports.PoolRecord.is(o.poolRecords[0])));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.CreateConcentratedLiquidityPoolsProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && Array.isArray(o.pool_records) && (!o.pool_records.length || exports.PoolRecord.isSDK(o.pool_records[0])));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.CreateConcentratedLiquidityPoolsProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && Array.isArray(o.pool_records) && (!o.pool_records.length || exports.PoolRecord.isAmino(o.pool_records[0])));
    },
...
exports.TickSpacingDecreaseProposal = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.TickSpacingDecreaseProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && Array.isArray(o.poolIdToTickSpacingRecords) && (!o.poolIdToTickSpacingRecords.length || exports.PoolIdToTickSpacingRecord.is(o.poolIdToTickSpacingRecords[0])));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.TickSpacingDecreaseProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && Array.isArray(o.pool_id_to_tick_spacing_records) && (!o.pool_id_to_tick_spacing_records.length || exports.PoolIdToTickSpacingRecord.isSDK(o.pool_id_to_tick_spacing_records[0])));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.TickSpacingDecreaseProposal.typeUrl || typeof o.title === "string" && typeof o.description === "string" && Array.isArray(o.pool_id_to_tick_spacing_records) && (!o.pool_id_to_tick_spacing_records.length || exports.PoolIdToTickSpacingRecord.isAmino(o.pool_id_to_tick_spacing_records[0])));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.title !== "") {
            writer.uint32(10).string(message.title);
    ...
    fromAmino(object) {
        ...
        message.poolIdToTickSpacingRecords = object.pool_id_to_tick_spacing_records?.map(e => exports.PoolIdToTickSpacingRecord.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.PoolIdToTickSpacingRecord = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.PoolIdToTickSpacingRecord.typeUrl || typeof o.poolId === "bigint" && typeof o.newTickSpacing === "bigint");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.PoolIdToTickSpacingRecord.typeUrl || typeof o.pool_id === "bigint" && typeof o.new_tick_spacing === "bigint");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.PoolIdToTickSpacingRecord.typeUrl || typeof o.pool_id === "bigint" && typeof o.new_tick_spacing === "bigint");
    },
...
exports.PoolRecord = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.PoolRecord.typeUrl || typeof o.denom0 === "string" && typeof o.denom1 === "string" && typeof o.tickSpacing === "bigint" && typeof o.spreadFactor === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.PoolRecord.typeUrl || typeof o.denom0 === "string" && typeof o.denom1 === "string" && typeof o.tick_spacing === "bigint" && typeof o.spread_factor === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.PoolRecord.typeUrl || typeof o.denom0 === "string" && typeof o.denom1 === "string" && typeof o.tick_spacing === "bigint" && typeof o.spread_factor === "string");
    },
