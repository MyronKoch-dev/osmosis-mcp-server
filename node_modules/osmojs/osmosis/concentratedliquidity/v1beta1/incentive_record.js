...
exports.IncentiveRecord = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.IncentiveRecord.typeUrl || typeof o.incentiveId === "bigint" && typeof o.poolId === "bigint" && exports.IncentiveRecordBody.is(o.incentiveRecordBody) && duration_1.Duration.is(o.minUptime));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.IncentiveRecord.typeUrl || typeof o.incentive_id === "bigint" && typeof o.pool_id === "bigint" && exports.IncentiveRecordBody.isSDK(o.incentive_record_body) && duration_1.Duration.isSDK(o.min_uptime));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.IncentiveRecord.typeUrl || typeof o.incentive_id === "bigint" && typeof o.pool_id === "bigint" && exports.IncentiveRecordBody.isAmino(o.incentive_record_body) && duration_1.Duration.isAmino(o.min_uptime));
    },
...
exports.IncentiveRecordBody = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.IncentiveRecordBody.typeUrl || coin_1.DecCoin.is(o.remainingCoin) && typeof o.emissionRate === "string" && timestamp_1.Timestamp.is(o.startTime));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.IncentiveRecordBody.typeUrl || coin_1.DecCoin.isSDK(o.remaining_coin) && typeof o.emission_rate === "string" && timestamp_1.Timestamp.isSDK(o.start_time));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.IncentiveRecordBody.typeUrl || coin_1.DecCoin.isAmino(o.remaining_coin) && typeof o.emission_rate === "string" && timestamp_1.Timestamp.isAmino(o.start_time));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
