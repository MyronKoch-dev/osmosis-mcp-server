...
exports.TickInfo = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.TickInfo.typeUrl || typeof o.liquidityGross === "string" && typeof o.liquidityNet === "string" && Array.isArray(o.spreadRewardGrowthOppositeDirectionOfLastTraversal) && (!o.spreadRewardGrowthOppositeDirectionOfLastTraversal.length || coin_1.DecCoin.is(o.spreadRewardGrowthOppositeDirectionOfLastTraversal[0])) && exports.UptimeTrackers.is(o.uptimeTrackers));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.TickInfo.typeUrl || typeof o.liquidity_gross === "string" && typeof o.liquidity_net === "string" && Array.isArray(o.spread_reward_growth_opposite_direction_of_last_traversal) && (!o.spread_reward_growth_opposite_direction_of_last_traversal.length || coin_1.DecCoin.isSDK(o.spread_reward_growth_opposite_direction_of_last_traversal[0])) && exports.UptimeTrackers.isSDK(o.uptime_trackers));
    },
    isAmino(o) {
...
exports.UptimeTrackers = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.UptimeTrackers.typeUrl || Array.isArray(o.list) && (!o.list.length || exports.UptimeTracker.is(o.list[0])));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.UptimeTrackers.typeUrl || Array.isArray(o.list) && (!o.list.length || exports.UptimeTracker.isSDK(o.list[0])));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.UptimeTrackers.typeUrl || Array.isArray(o.list) && (!o.list.length || exports.UptimeTracker.isAmino(o.list[0])));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.UptimeTracker = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.UptimeTracker.typeUrl || Array.isArray(o.uptimeGrowthOutside) && (!o.uptimeGrowthOutside.length || coin_1.DecCoin.is(o.uptimeGrowthOutside[0])));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.UptimeTracker.typeUrl || Array.isArray(o.uptime_growth_outside) && (!o.uptime_growth_outside.length || coin_1.DecCoin.isSDK(o.uptime_growth_outside[0])));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.UptimeTracker.typeUrl || Array.isArray(o.uptime_growth_outside) && (!o.uptime_growth_outside.length || coin_1.DecCoin.isAmino(o.uptime_growth_outside[0])));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromAmino(object) {
        const message = createBaseUptimeTracker();
        message.uptimeGrowthOutside = object.uptime_growth_outside?.map(e => coin_1.DecCoin.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
