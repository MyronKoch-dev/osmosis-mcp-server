...
exports.AccumulatorContent = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.AccumulatorContent.typeUrl || Array.isArray(o.accumValue) && (!o.accumValue.length || coin_1.DecCoin.is(o.accumValue[0])) && typeof o.totalShares === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.AccumulatorContent.typeUrl || Array.isArray(o.accum_value) && (!o.accum_value.length || coin_1.DecCoin.isSDK(o.accum_value[0])) && typeof o.total_shares === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.AccumulatorContent.typeUrl || Array.isArray(o.accum_value) && (!o.accum_value.length || coin_1.DecCoin.isAmino(o.accum_value[0])) && typeof o.total_shares === "string");
    },
    ...
    fromAmino(object) {
        const message = createBaseAccumulatorContent();
        message.accumValue = object.accum_value?.map(e => coin_1.DecCoin.fromAmino(e)) || [];
...
exports.Record = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.Record.typeUrl || typeof o.numShares === "string" && Array.isArray(o.accumValuePerShare) && (!o.accumValuePerShare.length || coin_1.DecCoin.is(o.accumValuePerShare[0])) && Array.isArray(o.unclaimedRewardsTotal) && (!o.unclaimedRewardsTotal.length || coin_1.DecCoin.is(o.unclaimedRewardsTotal[0])));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.Record.typeUrl || typeof o.num_shares === "string" && Array.isArray(o.accum_value_per_share) && (!o.accum_value_per_share.length || coin_1.DecCoin.isSDK(o.accum_value_per_share[0])) && Array.isArray(o.unclaimed_rewards_total) && (!o.unclaimed_rewards_total.length || coin_1.DecCoin.isSDK(o.unclaimed_rewards_total[0])));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.Record.typeUrl || typeof o.num_shares === "string" && Array.isArray(o.accum_value_per_share) && (!o.accum_value_per_share.length || coin_1.DecCoin.isAmino(o.accum_value_per_share[0])) && Array.isArray(o.unclaimed_rewards_total) && (!o.unclaimed_rewards_total.length || coin_1.DecCoin.isAmino(o.unclaimed_rewards_total[0])));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromAmino(object) {
        ...
        message.accumValuePerShare = object.accum_value_per_share?.map(e => coin_1.DecCoin.fromAmino(e)) || [];
        message.unclaimedRewardsTotal = object.unclaimed_rewards_total?.map(e => coin_1.DecCoin.fromAmino(e)) || [];
