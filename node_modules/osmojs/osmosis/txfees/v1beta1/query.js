...
exports.QueryEipBaseFeeResponse = exports.QueryEipBaseFeeRequest = exports.QueryBaseDenomResponse = exports.QueryBaseDenomRequest = exports.QueryDenomPoolIdResponse = exports.QueryDenomPoolIdRequest = exports.QueryDenomSpotPriceResponse = exports.QueryDenomSpotPriceRequest = exports.QueryFeeTokensResponse = exports.QueryFeeTokensRequest = void 0;
//@ts-nocheck
...
exports.QueryEipBaseFeeRequest = {
    ...
    is(o) {
        return o && o.$typeUrl === exports.QueryEipBaseFeeRequest.typeUrl;
    },
    isSDK(o) {
        return o && o.$typeUrl === exports.QueryEipBaseFeeRequest.typeUrl;
    },
    ...
    fromAminoMsg(object) {
        return exports.QueryEipBaseFeeRequest.fromAmino(object.value);
    },
    toAminoMsg(message) {
        return {
            type: "osmosis/txfees/query-eip-base-fee-request",
            value: exports.QueryEipBaseFeeRequest.toAmino(message)
        };
    },
    fromProtoMsg(message) {
        return exports.QueryEipBaseFeeRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QueryEipBaseFeeRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/osmosis.txfees.v1beta1.QueryEipBaseFeeRequest",
            value: exports.QueryEipBaseFeeRequest.encode(message).finish()
        };
    }
};
registry_1.GlobalDecoderRegistry.register(exports.QueryEipBaseFeeRequest.typeUrl, exports.QueryEipBaseFeeRequest);
registry_1.GlobalDecoderRegistry.registerAminoProtoMapping(exports.QueryEipBaseFeeRequest.aminoType, exports.QueryEipBaseFeeRequest.typeUrl);
...
exports.QueryEipBaseFeeResponse = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.QueryEipBaseFeeResponse.typeUrl || typeof o.baseFee === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.QueryEipBaseFeeResponse.typeUrl || typeof o.base_fee === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.QueryEipBaseFeeResponse.typeUrl || typeof o.base_fee === "string");
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.baseFee !== "") {
            writer.uint32(10).string(math_1.Decimal.fromUserInput(message.baseFee, 18).atomics);
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.baseFee = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromAminoMsg(object) {
        return exports.QueryEipBaseFeeResponse.fromAmino(object.value);
    },
    toAminoMsg(message) {
        return {
            type: "osmosis/txfees/query-eip-base-fee-response",
            value: exports.QueryEipBaseFeeResponse.toAmino(message)
        };
    },
    fromProtoMsg(message) {
        return exports.QueryEipBaseFeeResponse.decode(message.value);
    },
    toProto(message) {
        return exports.QueryEipBaseFeeResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/osmosis.txfees.v1beta1.QueryEipBaseFeeResponse",
            value: exports.QueryEipBaseFeeResponse.encode(message).finish()
        };
    }
};
registry_1.GlobalDecoderRegistry.register(exports.QueryEipBaseFeeResponse.typeUrl, exports.QueryEipBaseFeeResponse);
registry_1.GlobalDecoderRegistry.registerAminoProtoMapping(exports.QueryEipBaseFeeResponse.aminoType, exports.QueryEipBaseFeeResponse.typeUrl);
