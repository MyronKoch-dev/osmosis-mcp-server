...
class QueryClientImpl {
    ...
    getEipBaseFee(request = {}) {
        const data = query_1.QueryEipBaseFeeRequest.encode(request).finish();
        const promise = this.rpc.request("osmosis.txfees.v1beta1.Query", "GetEipBaseFee", data);
        return promise.then(data => query_1.QueryEipBaseFeeResponse.decode(new binary_1.BinaryReader(data)));
    }
}
