...
exports.GenesisDowntimeEntry = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.GenesisDowntimeEntry.typeUrl || (0, helpers_1.isSet)(o.duration) && timestamp_1.Timestamp.is(o.lastDowntime));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.GenesisDowntimeEntry.typeUrl || (0, helpers_1.isSet)(o.duration) && timestamp_1.Timestamp.isSDK(o.last_downtime));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.GenesisDowntimeEntry.typeUrl || (0, helpers_1.isSet)(o.duration) && timestamp_1.Timestamp.isAmino(o.last_downtime));
    },
...
registry_1.GlobalDecoderRegistry.register(exports.GenesisDowntimeEntry.typeUrl, exports.GenesisDowntimeEntry);
registry_1.GlobalDecoderRegistry.registerAminoProtoMapping(exports.GenesisDowntimeEntry.aminoType, exports.GenesisDowntimeEntry.typeUrl);
...
exports.GenesisState = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.GenesisState.typeUrl || Array.isArray(o.downtimes) && (!o.downtimes.length || exports.GenesisDowntimeEntry.is(o.downtimes[0])) && timestamp_1.Timestamp.is(o.lastBlockTime));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.GenesisState.typeUrl || Array.isArray(o.downtimes) && (!o.downtimes.length || exports.GenesisDowntimeEntry.isSDK(o.downtimes[0])) && timestamp_1.Timestamp.isSDK(o.last_block_time));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.GenesisState.typeUrl || Array.isArray(o.downtimes) && (!o.downtimes.length || exports.GenesisDowntimeEntry.isAmino(o.downtimes[0])) && timestamp_1.Timestamp.isAmino(o.last_block_time));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
