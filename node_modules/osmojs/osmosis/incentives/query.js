...
exports.QueryAllGroupsResponse = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.QueryAllGroupsResponse.typeUrl || Array.isArray(o.groups) && (!o.groups.length || group_1.Group.is(o.groups[0])));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.QueryAllGroupsResponse.typeUrl || Array.isArray(o.groups) && (!o.groups.length || group_1.Group.isSDK(o.groups[0])));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.QueryAllGroupsResponse.typeUrl || Array.isArray(o.groups) && (!o.groups.length || group_1.Group.isAmino(o.groups[0])));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.QueryAllGroupsGaugesResponse = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.QueryAllGroupsGaugesResponse.typeUrl || Array.isArray(o.gauges) && (!o.gauges.length || gauge_1.Gauge.is(o.gauges[0])));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.QueryAllGroupsGaugesResponse.typeUrl || Array.isArray(o.gauges) && (!o.gauges.length || gauge_1.Gauge.isSDK(o.gauges[0])));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.QueryAllGroupsGaugesResponse.typeUrl || Array.isArray(o.gauges) && (!o.gauges.length || gauge_1.Gauge.isAmino(o.gauges[0])));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.QueryAllGroupsWithGaugeResponse = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.QueryAllGroupsWithGaugeResponse.typeUrl || Array.isArray(o.groupsWithGauge) && (!o.groupsWithGauge.length || group_1.GroupsWithGauge.is(o.groupsWithGauge[0])));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.QueryAllGroupsWithGaugeResponse.typeUrl || Array.isArray(o.groups_with_gauge) && (!o.groups_with_gauge.length || group_1.GroupsWithGauge.isSDK(o.groups_with_gauge[0])));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.QueryAllGroupsWithGaugeResponse.typeUrl || Array.isArray(o.groups_with_gauge) && (!o.groups_with_gauge.length || group_1.GroupsWithGauge.isAmino(o.groups_with_gauge[0])));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromAmino(object) {
        const message = createBaseQueryAllGroupsWithGaugeResponse();
        message.groupsWithGauge = object.groups_with_gauge?.map(e => group_1.GroupsWithGauge.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.QueryGroupByGroupGaugeIDRequest = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.QueryGroupByGroupGaugeIDRequest.typeUrl || typeof o.id === "bigint");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.QueryGroupByGroupGaugeIDRequest.typeUrl || typeof o.id === "bigint");
    },
...
exports.QueryGroupByGroupGaugeIDResponse = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.QueryGroupByGroupGaugeIDResponse.typeUrl || group_1.Group.is(o.group));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.QueryGroupByGroupGaugeIDResponse.typeUrl || group_1.Group.isSDK(o.group));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.QueryGroupByGroupGaugeIDResponse.typeUrl || group_1.Group.isAmino(o.group));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.QueryCurrentWeightByGroupGaugeIDRequest = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.QueryCurrentWeightByGroupGaugeIDRequest.typeUrl || typeof o.groupGaugeId === "bigint");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.QueryCurrentWeightByGroupGaugeIDRequest.typeUrl || typeof o.group_gauge_id === "bigint");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.QueryCurrentWeightByGroupGaugeIDRequest.typeUrl || typeof o.group_gauge_id === "bigint");
    },
...
exports.QueryCurrentWeightByGroupGaugeIDResponse = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.QueryCurrentWeightByGroupGaugeIDResponse.typeUrl || Array.isArray(o.gaugeWeight) && (!o.gaugeWeight.length || exports.GaugeWeight.is(o.gaugeWeight[0])));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.QueryCurrentWeightByGroupGaugeIDResponse.typeUrl || Array.isArray(o.gauge_weight) && (!o.gauge_weight.length || exports.GaugeWeight.isSDK(o.gauge_weight[0])));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.QueryCurrentWeightByGroupGaugeIDResponse.typeUrl || Array.isArray(o.gauge_weight) && (!o.gauge_weight.length || exports.GaugeWeight.isAmino(o.gauge_weight[0])));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
    ...
    fromAmino(object) {
        const message = createBaseQueryCurrentWeightByGroupGaugeIDResponse();
        message.gaugeWeight = object.gauge_weight?.map(e => exports.GaugeWeight.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
...
exports.GaugeWeight = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.GaugeWeight.typeUrl || typeof o.gaugeId === "bigint" && typeof o.weightRatio === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.GaugeWeight.typeUrl || typeof o.gauge_id === "bigint" && typeof o.weight_ratio === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.GaugeWeight.typeUrl || typeof o.gauge_id === "bigint" && typeof o.weight_ratio === "string");
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        ...
        if (message.weightRatio !== "") {
            writer.uint32(18).string(math_1.Decimal.fromUserInput(message.weightRatio, 18).atomics);
        }
        return writer;
    },
    decode(input, length) {
