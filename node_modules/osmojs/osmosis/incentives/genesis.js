...
exports.GenesisState = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.GenesisState.typeUrl || params_1.Params.is(o.params) && Array.isArray(o.gauges) && (!o.gauges.length || gauge_1.Gauge.is(o.gauges[0])) && Array.isArray(o.lockableDurations) && (!o.lockableDurations.length || duration_1.Duration.is(o.lockableDurations[0])) && typeof o.lastGaugeId === "bigint" && Array.isArray(o.groupGauges) && (!o.groupGauges.length || gauge_1.Gauge.is(o.groupGauges[0])) && Array.isArray(o.groups) && (!o.groups.length || group_1.Group.is(o.groups[0])));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.GenesisState.typeUrl || params_1.Params.isSDK(o.params) && Array.isArray(o.gauges) && (!o.gauges.length || gauge_1.Gauge.isSDK(o.gauges[0])) && Array.isArray(o.lockable_durations) && (!o.lockable_durations.length || duration_1.Duration.isSDK(o.lockable_durations[0])) && typeof o.last_gauge_id === "bigint" && Array.isArray(o.group_gauges) && (!o.group_gauges.length || gauge_1.Gauge.isSDK(o.group_gauges[0])) && Array.isArray(o.groups) && (!o.groups.length || group_1.Group.isSDK(o.groups[0])));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.GenesisState.typeUrl || params_1.Params.isAmino(o.params) && Array.isArray(o.gauges) && (!o.gauges.length || gauge_1.Gauge.isAmino(o.gauges[0])) && Array.isArray(o.lockable_durations) && (!o.lockable_durations.length || duration_1.Duration.isAmino(o.lockable_durations[0])) && typeof o.last_gauge_id === "bigint" && Array.isArray(o.group_gauges) && (!o.group_gauges.length || gauge_1.Gauge.isAmino(o.group_gauges[0])) && Array.isArray(o.groups) && (!o.groups.length || group_1.Group.isAmino(o.groups[0])));
    },
    ...
    fromAmino(object) {
        ...
        message.groupGauges = object.group_gauges?.map(e => gauge_1.Gauge.fromAmino(e)) || [];
