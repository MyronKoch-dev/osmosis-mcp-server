...
exports.GenesisOwners = {
    ...
    toAmino(message) {
        ...
        obj.index_owners = message.indexOwners ? capability_1.CapabilityOwners.toAmino(message.indexOwners) : capability_1.CapabilityOwners.toAmino(capability_1.CapabilityOwners.fromPartial({}));
        return obj;
    },
    fromAminoMsg(object) {
