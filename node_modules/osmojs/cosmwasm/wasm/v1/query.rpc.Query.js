...
class QueryClientImpl {
    ...
    buildAddress(request) {
        const data = query_1.QueryBuildAddressRequest.encode(request).finish();
        const promise = this.rpc.request("cosmwasm.wasm.v1.Query", "BuildAddress", data);
        return promise.then(data => query_1.QueryBuildAddressResponse.decode(new binary_1.BinaryReader(data)));
    }
}
