...
class QueryClientImpl {
    ...
    connectionParams(request = {}) {
        const data = query_1.QueryConnectionParamsRequest.encode(request).finish();
        const promise = this.rpc.request("ibc.core.connection.v1.Query", "ConnectionParams", data);
        return promise.then(data => query_1.QueryConnectionParamsResponse.decode(new binary_1.BinaryReader(data)));
    }
}
