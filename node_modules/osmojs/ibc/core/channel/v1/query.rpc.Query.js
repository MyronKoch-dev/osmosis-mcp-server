...
class QueryClientImpl {
    ...
    nextSequenceSend(request) {
        const data = query_1.QueryNextSequenceSendRequest.encode(request).finish();
        const promise = this.rpc.request("ibc.core.channel.v1.Query", "NextSequenceSend", data);
        return promise.then(data => query_1.QueryNextSequenceSendResponse.decode(new binary_1.BinaryReader(data)));
    }
    upgradeError(request) {
        const data = query_1.QueryUpgradeErrorRequest.encode(request).finish();
        const promise = this.rpc.request("ibc.core.channel.v1.Query", "UpgradeError", data);
        return promise.then(data => query_1.QueryUpgradeErrorResponse.decode(new binary_1.BinaryReader(data)));
    }
    upgrade(request) {
        const data = query_1.QueryUpgradeRequest.encode(request).finish();
        const promise = this.rpc.request("ibc.core.channel.v1.Query", "Upgrade", data);
        return promise.then(data => query_1.QueryUpgradeResponse.decode(new binary_1.BinaryReader(data)));
    }
    channelParams(request = {}) {
        const data = query_1.QueryChannelParamsRequest.encode(request).finish();
        const promise = this.rpc.request("ibc.core.channel.v1.Query", "ChannelParams", data);
        return promise.then(data => query_1.QueryChannelParamsResponse.decode(new binary_1.BinaryReader(data)));
    }
}
