...
const createRPCQueryClient = async ({ rpcEndpoint }) => {
    ...
    return {
        ...
        ibc: {
            applications: {
                fee: {
                    v1: (await Promise.resolve().then(() => __importStar(require("./applications/fee/v1/query.rpc.Query")))).createRpcQueryExtension(client)
                },
                interchain_accounts: {
                    controller: {
                    ...
                    host: {
                        v1: (await Promise.resolve().then(() => __importStar(require("./applications/interchain_accounts/host/v1/query.rpc.Query")))).createRpcQueryExtension(client)
                    }
                },
                transfer: {
            ...
            lightclients: {
                wasm: {
                    v1: (await Promise.resolve().then(() => __importStar(require("./lightclients/wasm/v1/query.rpc.Query")))).createRpcQueryExtension(client)
                }
            }
        }
    };
