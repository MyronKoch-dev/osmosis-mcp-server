...
exports.MsgUpdateParamsResponse = exports.MsgUpdateParams = exports.MsgSendTxResponse = exports.MsgSendTx = exports.MsgRegisterInterchainAccountResponse = exports.MsgRegisterInterchainAccount = void 0;
...
exports.MsgRegisterInterchainAccount = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.MsgRegisterInterchainAccount.typeUrl || typeof o.owner === "string" && typeof o.connectionId === "string" && typeof o.version === "string" && (0, helpers_1.isSet)(o.ordering));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.MsgRegisterInterchainAccount.typeUrl || typeof o.owner === "string" && typeof o.connection_id === "string" && typeof o.version === "string" && (0, helpers_1.isSet)(o.ordering));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.MsgRegisterInterchainAccount.typeUrl || typeof o.owner === "string" && typeof o.connection_id === "string" && typeof o.version === "string" && (0, helpers_1.isSet)(o.ordering));
    },
...
exports.MsgRegisterInterchainAccountResponse = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.MsgRegisterInterchainAccountResponse.typeUrl || typeof o.channelId === "string" && typeof o.portId === "string");
    },
    isSDK(o) {
...
exports.MsgSendTx = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.MsgSendTx.typeUrl || typeof o.owner === "string" && typeof o.connectionId === "string" && packet_1.InterchainAccountPacketData.is(o.packetData) && typeof o.relativeTimeout === "bigint");
    },
    isSDK(o) {
    ...
    fromPartial(object) {
        ...
        message.owner = object.owner ?? "";
        message.connectionId = object.connectionId ?? "";
        message.packetData = object.packetData !== undefined && object.packetData !== null ? packet_1.InterchainAccountPacketData.fromPartial(object.packetData) : undefined;
    ...
    fromAmino(object) {
        ...
        if (object.packet_data !== undefined && object.packet_data !== null) {
            message.packetData = packet_1.InterchainAccountPacketData.fromAmino(object.packet_data);
        }
    ...
    toAmino(message) {
        ...
        obj.owner = message.owner === "" ? undefined : message.owner;
        obj.connection_id = message.connectionId === "" ? undefined : message.connectionId;
        obj.packet_data = message.packetData ? packet_1.InterchainAccountPacketData.toAmino(message.packetData) : undefined;
