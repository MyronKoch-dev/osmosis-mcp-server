...
const createLCDClient = async ({ restEndpoint }) => {
    ...
    return {
        ...
        ibc: {
            applications: {
                fee: {
                    v1: new (await Promise.resolve().then(() => __importStar(require("./applications/fee/v1/query.lcd")))).LCDQueryClient({
                        requestClient
                    })
                },
                interchain_accounts: {
                    ...
                    host: {
                        v1: new (await Promise.resolve().then(() => __importStar(require("./applications/interchain_accounts/host/v1/query.lcd")))).LCDQueryClient({
                            requestClient
                        })
                    }
                },
            ...
            lightclients: {
                wasm: {
                    v1: new (await Promise.resolve().then(() => __importStar(require("./lightclients/wasm/v1/query.lcd")))).LCDQueryClient({
                        requestClient
                    })
                }
            }
