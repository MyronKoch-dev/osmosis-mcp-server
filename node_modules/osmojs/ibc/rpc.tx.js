...
const createRPCMsgClient = async ({ rpc }) => ({
    ...
    ibc: {
        applications: {
            fee: {
                v1: new (await Promise.resolve().then(() => __importStar(require("./applications/fee/v1/tx.rpc.msg")))).MsgClientImpl(rpc)
            },
            interchain_accounts: {
                controller: {
                ...
                host: {
                    v1: new (await Promise.resolve().then(() => __importStar(require("./applications/interchain_accounts/host/v1/tx.rpc.msg")))).MsgClientImpl(rpc)
                }
            },
            transfer: {
        ...
        lightclients: {
            wasm: {
                v1: new (await Promise.resolve().then(() => __importStar(require("./lightclients/wasm/v1/tx.rpc.msg")))).MsgClientImpl(rpc)
            }
        }
    }
});
